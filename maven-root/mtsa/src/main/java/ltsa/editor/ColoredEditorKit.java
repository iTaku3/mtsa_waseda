...
public class ColoredEditorKit extends DefaultEditorKit {
  ...
  /**
   * Fetches a factory that is suitable for producing views of any models that are produced by this
   * kit. The default is to have the UI produce the factory, so this method has no implementation.
   *
  ...
  /**
   * Create a copy of the editor kit. This allows an implementation to serve as a prototype for
   * others, so that they can be quickly created.
   */
  public Object clone() {
