...
public class ColoredDocument extends PlainDocument {
  ...
  /**
   * Fetch a reasonable location to start scanning given the desired start location. This allows for
   * adjustments needed to accomodate multiline comments. Currently scans the complete document.
