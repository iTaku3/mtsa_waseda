    ...
    private void handlePopup(MouseEvent event) {
      ...
      if (pickSupport != null) {
        ...
        if (v != null) {
          ...
          popup.add(
              new AbstractAction("Select next states") {
          ...
          popup.add(
              new AbstractAction("Select previous states") {
                public void actionPerformed(ActionEvent e) {
                  view.selectPrevious();
                  view.repaint();
                }
          ...
          popup.add(
              new AbstractAction("Select reachable states") {
                public void actionPerformed(ActionEvent e) {
          ...
          popup.add(
              new AbstractAction("Select reaching states") {
                public void actionPerformed(ActionEvent e) {
                  view.selectReaching();
                  view.repaint();
                }
