...
public class ControlStackDefinition implements Iterable<ControlTierDefinition> {
  ...
  private static Hashtable<String, ControlStackDefinition> controlStacks =
      new Hashtable<String, ControlStackDefinition>();
  ...
  public static ControlStackDefinition getDefinition(String name) {
    if (name == null) throw new IllegalArgumentException("Missing name in getDefinition()");
