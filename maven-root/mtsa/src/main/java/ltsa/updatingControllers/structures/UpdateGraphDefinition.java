...
public class UpdateGraphDefinition {
  ...
  /**
   * @param initialProblem The symbol that represents the initial state of an update graph. Used in
   *     graphUpdate controllers.
   */
  ...
  /**
   * @param transitions The set of transitions that represents the new transitions for an update
   *     graph. Used in graphUpdate controllers.
   */
