...
/**
 * ONLY to share configuration settings across MTSA. Singleton, do not manually instantiate, use
 * "getInstance()". Update variables values from HPWindow and LTSABatch.
 *
...
public class ComputerOptions {
  ...
  public ConcurrentHashMap<Object, ReentrantLock> rankStatesLock =
  ...
  public void setAllowedThreads(int allowedThreads) throws NumberFormatException {
    if (allowedThreads > 0) this.allowedThreads = allowedThreads;
  }
}
