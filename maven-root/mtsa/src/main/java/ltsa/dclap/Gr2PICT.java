...
public class Gr2PICT extends java.awt.Graphics {
  ...
  /**
   * Constructs a new Gr2PICT Object. Unlike regular Graphics objects, Gr2PICT contexts can be
   * created directly.
   *
  ...
  protected final void emitroundrect(
      int opcode, int x, int y, int width, int height, int arcWidth, int arcHeight) {
    emitop(QD.oOvSize);
    emitword(arcHeight);
    emitword(arcWidth);
    emitop(opcode);
   ...
   * Object. This method translates the specified parameters, x and y, to the proper origin
   * coordinates and then clips the Graphics Object to the area.
   *
   ...
   * area and the specified rectangle. Graphic operations have no effect outside of the clipping
   * area.
   *
   * @param x the x coordinate
   * @param y the y coordinate
  ...
  /**
   * Draws the outline of the specified rectangle using the current color. Use drawRect(x, y,
   * width-1, height-1) to draw the outline inside the specified rectangle.
   *
   * @param x the x coordinate
   * @param y the y coordinate
   * @param width the width of the rectangle
   ...
   * drawing surface. Which drawing surface it selects depends on how the graphics context was
   * created.
   *
   * @param x the x coordinate
   * @param y the y coordinate
  ...
  /**
   * Draws an arc bounded by the specified rectangle from startAngle to endAngle. 0 degrees is at
   * the 3-o'clock position.Positive arc angles indicate counter-clockwise rotations, negative arc
   * angles are drawn clockwise.
   *
   * @param x the x coordinate
   * @param y the y coordinate
   * @param width the width of the rectangle
  ...
  /**
   * Draws the specified String using the current font and color. The x,y position is the starting
   * point of the baseline of the String.
   *
  ...
  public boolean doImage(
      Image img, int x, int y, int width, int height, ImageObserver observer, Color bgcolor) {
    /******
     *
  ...
  /**
   * Draws the specified image at the specified coordinate (x, y). If the image is incomplete the
  ...
  /**
   * Draws the specified image inside the specified rectangle. The image is scaled if necessary. If
