...
public interface Animator {
  ...
  /**
   * initialises the Animator with the list of actions that are to be controlled menu is a vector of
   * strings returns bitset of eligible menu actions
   */
  ...
  /**
   * causes the Animator to take a single step by choosing one of the eligible menu actions returns
   * a bitset of eligible menu actions
   */
