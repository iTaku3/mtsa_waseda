...
/** Compresses integer vector of a a composite machine state into a bit packed byte vector */
public class StateCodec {
  ...
  public int bits() {
    int nb = 0;
    for (int i = 0; i < bitSize.length; ++i) nb += bitSize[i];
    return nb;
  }
  ...
  /*
   * test harness public static void main ( String[] args ) { int test[] = {1024,
