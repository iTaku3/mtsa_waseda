...
public class CompactStateUtils {
  ...
  /**
   * This method assumes that in the CompactState structure any EventState could be probabilistic.
      ...
      if (es instanceof ProbabilisticEventState) {
        ...
        res =
            new ProbabilisticEventState(
                probCurr.event, probCurr.next, probCurr.getProbability(), probCurr.getBundle());
