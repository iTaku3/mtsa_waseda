...
public class AssertDefinition {
  ...
  public static void put(
    ...
    if (!isConstraint) {
      if (definitions.put(n.toString(), new AssertDefinition(n, f, ls, ip, p, false, false))
          != null) Diagnostics.fatal("duplicate LTL property definition: " + n, n);
    } else {
      if (constraints.put(n.toString(), new AssertDefinition(n, f, ls, ip, p, true, isProperty))
          != null) Diagnostics.fatal("duplicate LTL constraint/property definition: " + n, n);
    }
  }
  ...
  public static CompactState compileConstraint(
      LTSOutput output, Symbol name, String refname, Vector pvalues) {
  ...
  private static CompositeState compile(
      Hashtable definitions, LTSOutput output, String asserted, boolean isconstraint) {
