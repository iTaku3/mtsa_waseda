...
public class FormulaUtils {
  ...
  /**
   * Transforms the formula to a Formula as needed by the synthesiser. The fluents involved in the
   * Formula are added to the set.
   *
   * @param formula
   * @param involvedFluents
   * @return
   */
  public static Formula adaptFormulaAndCreateFluents(
    ...
    UpdatingControllersUtils.ACTION_FLUENTS_FOR_UPDATE.addAll(
        formulaTransformerVisitor.getActionFluentsForUpdate());
