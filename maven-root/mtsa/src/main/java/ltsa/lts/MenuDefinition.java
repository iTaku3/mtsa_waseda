...
public class MenuDefinition {
  ...
  public static String[] names() {
    ...
    String na[];
    if (n == 0) return null;
    else na = new String[n];
    Enumeration e = definitions.keys();
    int i = 0;
    while (e.hasMoreElements()) na[i++] = (String) e.nextElement();
    return na;
  }
  ...
  public RunMenu makeRunMenu() {
    ...
    if (params == null) {
      ...
      if (a == null) a = new Relation();
      else a = a.inverse();
      if (c == null) c = new Relation();
      else c = c.inverse();
      includeParts(a, c);
  ...
  class AnimationPart {
    ...
    Relation getActions() {
      if (compiled != null) return compiled.actions;
      else return null;
    }

    Relation getControls() {
      if (compiled != null) return compiled.controls;
      else return null;
    }
  } // end AnimationPart
}
