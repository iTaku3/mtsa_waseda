    ...
    while (p != null) {
      ...
      while (q != null) {
        int next =
            q.next < 0
                ? Declaration.ERROR
                : ((Integer) oldtonew.get(new Integer(q.next))).intValue();
          ...
          newhead =
              EventStateUtils.add(
                  ...
                  new ProbabilisticEventState(
                      q.event,
                      next,
                      ((ProbabilisticEventState) q).getProbability(),
                      ((ProbabilisticEventState) q).getBundle()));
          ProbabilisticEventState probSt =
              (ProbabilisticEventState) ((ProbabilisticEventState) q).probTr;
          while (probSt != null) {
            next =
                probSt.next < 0
                    ? Declaration.ERROR
                    : ((Integer) oldtonew.get(new Integer(probSt.next))).intValue();
            newhead =
                EventStateUtils.add(
                    newhead,
                    new ProbabilisticEventState(
    ...
    while (stack != null) {
      ...
      if (!visited.containsKey(v)) {
        ...
        while (p != null) {
          EventState q = p;
          while (q != null) {
            if (q.next >= 0 && !visited.containsKey(q.next)) stack = EventState.push(stack, q);
          ...
          do {
            res =
                EventStateUtils.add(
                    res,
                    new ProbabilisticEventState(
                        probQ.next, probQ.event, probQ.getProbability(), probQ.getBundle()));
