...
public class EventStateFactory {
  ...
  public static ProbabilisticEventState createProbabilisticEventState(
      int event, Transition t, int bundle) {
    ProbabilisticTransition pTr =
        new ProbabilisticTransition(t.from, t.event, t.to, BigDecimal.ONE, bundle);
    return new ProbabilisticEventState(event, pTr.to, pTr.prob, pTr.probBundle);
  }
}
