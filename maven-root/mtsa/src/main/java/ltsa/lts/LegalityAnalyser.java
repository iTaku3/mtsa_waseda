...
public class LegalityAnalyser extends Analyser {
  ...
  public LegalityAnalyser(
      CompositeState cs, LTSOutput output, int source, int target, List<String> actionSet) {
    super(cs, output, null);
    this.sourceMachineIndex = source;
    this.targetMachineIndex = target;
    this.actionSet = actionSet;
    this.engine =
        new DFSLegalCompositionEngine(coder, sourceMachineIndex, targetMachineIndex, actionSet);
  }
