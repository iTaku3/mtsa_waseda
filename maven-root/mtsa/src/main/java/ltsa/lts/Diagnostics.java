...
public class Diagnostics {
  ...
  public static void fatal(String errorMsg, Symbol symbol) {
    if (symbol != null) throw new LTSException(errorMsg, new Integer(symbol.startPos));
    else throw new LTSException(errorMsg);
  }
  ...
  public static void warning(String warningMsg, String errorMsg, Symbol symbol) {
    if (warningsAreErrors) {
      ...
      if (output == null) fatal("Diagnostic not initialised");
