...
public class RunEnactorsWindow<State, Action> extends JFrame {
  ...
  public RunEnactorsWindow(BaseController<State, Action> controllerScheduler) {
    ...
    UpdatingControllersAnimatorUtils.actualControllableActionsPanel.setLayout(
        new BoxLayout(
            UpdatingControllersAnimatorUtils.actualControllableActionsPanel, BoxLayout.Y_AXIS));

    UpdatingControllersAnimatorUtils.actualControllableActionsPanel.setBackground(Color.LIGHT_GRAY);
    JScrollPane scrollPane =
        new JScrollPane(UpdatingControllersAnimatorUtils.actualControllableActionsPanel);
    ...
    ltsView.initialize(
        controllerScheduler.getLts(),
        controllerScheduler.getLts().getInitialState(),
        controllerScheduler);
