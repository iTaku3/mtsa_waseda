...
public abstract class FindDialog extends JDialog {
  ...
  JRadioButton upRadioButton, downRadioButton, allLinesRadioButton, selectedLinesRadioButton;
  JButton findButton, replaceButton, replaceFindButton, replaceAllButton, closeButton;
  JLabel statusLabel;
  ...
  public FindDialog(Frame container) {
    ...
    JLabel findLabel = new JLabel("Find:"), replaceLabel = new JLabel("Replace With:");
    ...
    findButton.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            if (startIndex < 0) statusLabel.setText("String not found.");
            else {
    ...
    replaceFindButton.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            JTextComponent t = currentTextComponent();
            ...
            if (t.getSelectedText() == null)
              ...
              t.setText(
                  t.getText().substring(0, t.getSelectionStart())
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            t.setText(
                t.getText()
                    .replaceAll(
                        matchingExpression(findField.getText(), matchCaseCheckBox.isSelected()),
                        replaceField.getText()));
            t.setSelectionStart(startIndex);
    ...
    int w = Math.max(directionPanel.getPreferredSize().width, scopePanel.getPreferredSize().width),
        h =
            Math.max(
                directionPanel.getPreferredSize().height, scopePanel.getPreferredSize().height);
  ...
  int findNext(
    ...
    if (index < 0 && wrap) index = searchDown ? text.indexOf(query) : text.lastIndexOf(query);
