 ...
 * @author placiana
 */
public class BisimulationWindow extends RefinementWindow { // JFrame {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;

    public BisimulationWindow(HPWindow window, RefinementOptions refinementOptions, String[] models,
            SemanticType[] refinemetTypes) {
        super(window, refinementOptions, models, refinemetTypes, RefinementWindow.Mode.REFINEMENT);
    }
    ...
    private void checkRefinement(int refinesModel, int refinedModel) {
        ...
        this.refinementOptions.setBidirectionalCheck(true);
    ...
    protected void initComponents(String[] models, SemanticType[] refinemetTypes, Mode mode) {
        ...
        if (mode == Mode.REFINEMENT) {
            this.setTitle("Models to check bisimulation");
            // jLlabelModelsToCheck.setText("Models to check refinement");
            labelRefines.setText("is bisimilar to...");
        }

        GroupLayout jPanel2Layout = new GroupLayout(jPanel2);
        jPanel2.setLayout(jPanel2Layout);
        jPanel2Layout.setHorizontalGroup(
                jPanel2Layout.createParallelGroup(GroupLayout.LEADING).add(jPanel2Layout.createSequentialGroup()
                        .add(15, 15, 15).add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
//                    .add(jPanel2Layout.createSequentialGroup()
//                        .add(jLlabelModelsToCheck, GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE)
//                        .addContainerGap()
//                        )
                                .add(jPanel2Layout.createSequentialGroup()
                                        .add(comboRefinedModelFrom, GroupLayout.PREFERRED_SIZE, 150,
                                                GroupLayout.PREFERRED_SIZE)
                                        .add(15, 15, 15).add(labelRefines)
                                        .addPreferredGap(LayoutStyle.RELATED, 35, Short.MAX_VALUE)
                                        .add(comboRefinedModel, GroupLayout.PREFERRED_SIZE, 150,
                                                GroupLayout.PREFERRED_SIZE)
                                        .add(15, 15, 15)))));
...
//                .add(jLlabelModelsToCheck)
                        ...
                        .add(jPanel2Layout.createParallelGroup(GroupLayout.BASELINE)
                                .add(comboRefinedModel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.PREFERRED_SIZE)
                                .add(comboRefinedModelFrom, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.PREFERRED_SIZE)
                                .add(labelRefines))
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.LEADING)
                .add(jPanel1Layout.createSequentialGroup().add(15, 15, 15)
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.LEADING)
                .add(jPanel1Layout.createSequentialGroup().add(15, 15, 15)
                        .add(jPanel1Layout.createParallelGroup(GroupLayout.BASELINE).add(labelRefinementSemantic).add(
                                comboRefinementSemantics, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                GroupLayout.PREFERRED_SIZE))
        ...
        jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(GroupLayout.LEADING)
                .add(GroupLayout.TRAILING, jPanel3Layout.createSequentialGroup().addContainerGap(286, Short.MAX_VALUE)
                        .add(buttonCheck).addContainerGap()));
        jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(GroupLayout.LEADING).add(GroupLayout.TRAILING,
                jPanel3Layout.createSequentialGroup().addContainerGap(15, Short.MAX_VALUE).add(buttonCheck).add(15, 15,
                        15)));
                ...
                .add(layout.createParallelGroup(GroupLayout.LEADING)
                        .add(GroupLayout.TRAILING,
                                layout.createSequentialGroup()
                                        .add(jPanel2, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE)
                                        .addContainerGap())
                        .add(GroupLayout.TRAILING,
                                layout.createSequentialGroup()
                                        .add(layout.createParallelGroup(GroupLayout.TRAILING)
                                                .add(GroupLayout.LEADING, jPanel3, GroupLayout.DEFAULT_SIZE,
                                                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .add(jPanel1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                        Short.MAX_VALUE))
                                        .add(20, 20, 20)))));
