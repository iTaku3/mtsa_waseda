...
/**
 * Concrete form of MTSTransition with convenience methods XXX: use interface MTSTransition. See if
 * MTSTransitionWithModalityInfo can be used
 */
public class Transition extends MTSTransitionImpl<String, Long> {
  ...
  public String ltsName() {
    if (this.type() == MTS.TransitionType.MAYBE) return this.name().concat("?");
