...
public class LTSASplash extends Window {
  ...
  String label_text =
      "The Modal Transition Analyser (MTSA) is a fork of the Labelled Transition System Analyzer"
          + " developed at Imperial College London initially by Jeff Magee.\n\n"
          + "MTSA is a research effort by the Laboratory on Foundations and Tools for Software"
          + " Engineering (LaFHIS) at University of Buenos Aires";
