...
public class StepwiseWindow extends JSplitPane implements LTSOutput, EventClient {
    ...
    StepwiseWindow thisWindow;
    private final static int MAXPRINT = Integer.MAX_VALUE;

    public StepwiseWindow (CompositeState cs,EventManager eman) {
      super();
      this.eman = eman;
      thisWindow = this;
      ...
      list.addListSelectionListener(new StepwiseAction());
  ...
  class StepwiseAction implements ListSelectionListener {
