...
public class RefinedMTS {
  ...
  public ArrayList<RefinedMTSTransition> getTransitions(
      RefinedMTSState state, TransitionType type) {
  ...
  public boolean removeTransition(
      RefinedMTSState from, String event, RefinedMTSState to, TransitionType type) {
    boolean result = false;
