...
public class CommunicationStopMessage extends Message {	
	public static int MESSAGE_ID				= 3;
	
	public CommunicationStopMessage(int to, int from){
		super(MESSAGE_ID, 1, to, from);
	}
	
	public CommunicationStopMessage(String serializedMessage){
