...
public class RobotStatusMessage extends Message {
  ...
  public int getMessageLength() {
    return super.getMessageLength()
        + LEFT_SPEED_FIELD_LENGTH
        + RIGHT_SPEED_FIELD_LENGTH
        + LEFT_IR_FIELD_LENGTH
        + RIGHT_IR_FIELD_LENGTH
        + BATTERY_FIELD_LENGTH;
  }
  ...
  protected String writeData() {
    return String.format(
        "%04d%04d%04d%04d%04d",
        leftSpeedValue, rightSpeedValue, leftIRValue, rightIRValue, batteryValue);
  }
