...
public class PainterEnvironmentSimulation<State, Action> extends RobotAdapter<State, Action> {

  public static String IMAGE_PATH =
      System.getProperty("user.dir") + "/src/main/resources/PainterUpdateImg/";
  // controllable
  ...
  public PainterEnvironmentSimulation(
      String name,
      Action success,
      Action failure,
      Action lost,
  ...
  private boolean isNotOkArm1(Action action) {
    ...
    return action.equals(dryNOk1)
        || action.equals(mPaintNOk1)
        || action.equals(gPaintNOk1)
        || action.equals(varnishNOk1);
  }

  private boolean isNotOkArm2(Action action) {

    return action.equals(dryNOk2)
        || action.equals(mPaintNOk2)
        || action.equals(gPaintNOk2)
