...
public class NXTRobotComm {
  ...
  public void follow() throws IOException, NXTRobotLostException, NXTCommException {
    ...
    else if (cmdResp == RobotDriverCommCommands.ROBOT_LOST) throw new NXTRobotLostException();
    else throw new NXTCommException(cmdResp);
  }
  ...
  public void endCommunication() throws IOException, NXTCommException {
    ...
    int cmdResp = streamInput.readInt();
    if (cmdResp == RobotDriverCommCommands.SUCCESS) return;
    else throw new NXTCommException();
  }
