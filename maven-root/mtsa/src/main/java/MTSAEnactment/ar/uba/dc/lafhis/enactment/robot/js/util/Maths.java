...
public abstract class Maths {
   ...
   * @return mapped value
   * @throws IllegalArgumentException if the source range is a singularity, i.e., both of its bounds
   *     are equal
   */
  ...
  /**
   * Normalizes the given value from the given range. In other words, evaluates the linear mapping
   * from the given range to the unit range for the given value. A value equal to the lower bound is
   * mapped to 0. A value equal to the upper bound is mapped to 1. All other values are mapped
   ...
   * @throws IllegalArgumentException if the range is a singularity, i.e., both of its bounds are
   *     equal
   */
  ...
  /**
   * Scales the given value to the given range. In other words, evaluates the linear mapping from
   * the unit range to the given range for the given value. A value of 0 is mapped to the lower
   * bound. A value of 1 is mapped to the upper bound. All other values are mapped linearly between
   * the bounds.
   *
