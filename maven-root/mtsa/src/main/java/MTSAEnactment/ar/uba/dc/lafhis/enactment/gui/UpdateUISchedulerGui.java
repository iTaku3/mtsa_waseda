...
public class UpdateUISchedulerGui extends JFrame {
  ...
  public UpdateUISchedulerGui() {
    ...
    lblControllableLabel =
        new JLabel("<html><div style='text-align: center;'>Controller<br/>Actions</div></html>");
    ...
    lblEnvironmentLabel =
        new JLabel("<html><div style='text-align: center;'>Environment<br/>Actions</div></html>");
