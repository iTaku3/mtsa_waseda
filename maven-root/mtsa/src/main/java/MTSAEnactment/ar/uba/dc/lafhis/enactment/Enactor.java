 ...
 *
 * <p>Extend this class to implement new Enactors Need to implement
 * primitiveHandleTransitionEvent(), setUp() and tearDown() functions
 *
 * @author Julio
 * @param <State>
 * @param <Action>
 */
public abstract class Enactor<State, Action> extends TransitionDispatcher<Action>
   ...
   * @throws Exception
   */
  protected abstract void primitiveHandleTransitionEvent(TransitionEvent<Action> transitionEvent)
      throws Exception;
  ...
  protected synchronized void addTransition(TransitionEvent<Action> transitionEvent) {
    //		System.out.println("Enactor (" + this.getName() + ") - add transition event: " +
    // transitionEvent.getAction().toString());
