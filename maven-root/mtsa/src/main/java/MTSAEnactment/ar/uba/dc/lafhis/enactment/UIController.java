...
public class UIController<State, Action> extends BaseController<State, Action> {
  ...
  public UIController(String name, LTS<State, Action> lts, Set<Action> controllableActions) {
  ...
  private void updateInterface() {
    ...
    for (Action action : this.optControllableActions)
      this.uiControllerGui.addControllableAction(
          action.toString(),
          action.toString(),
          new ActionListener() {
    ...
    for (Action action : this.optUnControllableActions)
      this.uiControllerGui.addUnControllableAction(
          action.toString(),
          action.toString(),
          new ActionListener() {
