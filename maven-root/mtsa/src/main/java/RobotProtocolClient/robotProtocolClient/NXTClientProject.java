...
public class NXTClientProject extends JFrame
  ...
  protected void initGui() {
    ...
    try {
      inputLtsDocument.insertString(
          ...
          "FOLLOW = (follow -> (success -> TURN | lost -> LOST)), TURN = (turnLeft -> (success ->"
              + " FOLLOW | lost -> LOST))."
          // "START = (calibrate -> success -> FOLLOW ), FOLLOW = (follow -> (success -> TURN | lost
          // -> LOST)), TURN = (turnLeft -> (success -> FOLLOW | lost -> LOST))."
            ...
            try {
              LTSAdapter<Long, String> ltsAdapter =
                  new LTSAdapter<Long, String>(
                      MTSCompiler.getInstance()
                          .compileMTS("controller", inputLtsTextPane.getText()),
    ...
    buttonSetupVars.addActionListener(
        new ActionListener() {
