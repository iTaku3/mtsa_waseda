...
public class GamePrunningExperimentReporter {
  ...
  public static void main(String[] args) {
    ...
    if (args.length > 0) resultsFolder = args[0];
    else resultsFolder = RESULTS_FOLDER;
    ...
    for (File file : files) {
      try {
        ...
        JSONCompatibleString jsonShortName =
            getJSONCompatibleStringFromJSON(results, GamePrunningExperiment.SHORT_NAME_RESULT);
        JSONCompatibleObject jsonInitTime =
            getJSONCompatibleObjectFromJSON(results, GamePrunningExperiment.INIT_TIME_RESULT);
        JSONCompatibleObject jsonEndTime =
            getJSONCompatibleObjectFromJSON(results, GamePrunningExperiment.END_TIME_RESULT);

        JSONCompatibleInt jsonInitState =
            getJSONCompatibleIntFromJSON(results, GamePrunningExperiment.INIT_STATE_RESULT);
        JSONCompatibleInt jsonEndState =
            getJSONCompatibleIntFromJSON(results, GamePrunningExperiment.END_STATE_RESULT);
        JSONCompatibleInt jsonEnvState =
            getJSONCompatibleIntFromJSON(results, GamePrunningExperiment.ENV_STATE_RESULT);
        JSONCompatibleInt jsonCtrlState =
            getJSONCompatibleIntFromJSON(results, GamePrunningExperiment.CTRL_STATE_RESULT);

        DirectedSparseMultigraph<
                ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>
            jsonGameGraph =
                getDirectedGraphFromJSON(results, GamePrunningExperiment.GAME_GRAPH_RESULT);
        DirectedSparseMultigraph<
                ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>
            jsonEnvGraph =
                getDirectedGraphFromJSON(results, GamePrunningExperiment.ENV_GRAPH_RESULT);
        DirectedSparseMultigraph<
                ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>
            jsonCtrlGraph =
                getDirectedGraphFromJSON(results, GamePrunningExperiment.CTRL_GRAPH_RESULT);
  ...
  public static JSONCompatibleString getJSONCompatibleStringFromJSON(
      JSONObject results, String key) {
  ...
  public static JSONCompatibleObject getJSONCompatibleObjectFromJSON(
      JSONObject results, String key) {
    return new JSONCompatibleObject((Object) ((JSONObject) results.get(key)).get("value"));
  }

  public static JSONCompatibleBoolean getJSONCompatibleBooleanFromJSON(
      JSONObject results, String key) {
    return new JSONCompatibleBoolean((boolean) ((JSONObject) results.get(key)).get("value"));
  }

  public static DirectedSparseMultigraph<
          ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>
      getDirectedGraphFromJSON(JSONObject results, String key) {
    ...
    Map<Long, ExperimentJUNGGameNodeValue<Long>> json2Graph =
        new HashMap<Long, ExperimentJUNGGameNodeValue<Long>>();
    ...
    for (int i = 0; i < verticesObject.size(); i++) {
      ...
      for (int j = 0; j < currentFluentsObject.size(); j++) {
        ...
        nodeFluents.add(
            new ExperimentJUNGGameFluent(
                (String) currentFluent.get("name"), ((boolean) currentFluent.get("value"))));
      }

      currentNode =
          new ExperimentJUNGGameNodeValue<Long>(
              vertexId,
              nodeFluents,
              (boolean) vertex.get("isWinning"),
              (boolean) vertex.get("isInitial"));
    ...
    for (int i = 0; i < edgesObject.size(); i++) {
      ...
      currentEdge =
          new ExperimentJUNGGameEdgeValue<String, Long>(
              (String) edge.get("id"), fromState, toState, (boolean) edge.get("isControllable"));
