...
public class ExperimentJUNGGraphVisualization extends ExperimentResultVisualization {
  ...
  protected VisualizationViewer<
          ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>
      visualizationViewer;
  ...
  public ExperimentJUNGGraphVisualization(JSONCompatibleObject jsonGraph, Dimension dimension)
      throws Exception {
    super(jsonGraph);
  ...
  public BufferedImage getGraphImage() {
    ...
    BufferedImage image =
        (BufferedImage)
            visualizationServer.getImage(
                new Point2D.Double(
                    visualizationViewer.getGraphLayout().getSize().getWidth() / 2,
  ...
  protected void initializeViewer() throws Exception {
    if (!(jsonValue instanceof JSONCompatibleObject))
      throw new Exception(
          "ExperimentJUNGGraphVisualization::buildComponent value should be of type"
    ...
    if (!(jsonObject.getValue() instanceof DirectedSparseMultigraph))
      throw new Exception(
          "ExperimentJUNGGraphVisualization::ExperimentJUNGGraphVisualization value should be of"
              + " type DirectedGraph");

    DirectedSparseMultigraph<
            ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>
        graph = (DirectedSparseMultigraph) jsonObject.getValue();

    // The Layout<V, E> is parameterized by the vertex and edge types
    Layout<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>> layout =
        new ISOMLayout<
            ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>(
            (Graph<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>)
                graph);
    ...
    visualizationViewer =
        new VisualizationViewer<
            ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>(layout);
    Dimension visibleDimension =
        new Dimension(dimension.width + MARGIN_W, dimension.height + MARGIN_H);
    visualizationViewer.setPreferredSize(visibleDimension); // Sets the viewing area size

    Transformer<ExperimentJUNGGameEdgeValue<String, Long>, Font> edgeFont =
        new Transformer<ExperimentJUNGGameEdgeValue<String, Long>, Font>() {
          public Font transform(ExperimentJUNGGameEdgeValue<String, Long> edge) {
            return new Font("Garamond", Font.PLAIN, 11);
          }
        };
    Transformer<ExperimentJUNGGameNodeValue<Long>, Font> vertexFont =
        new Transformer<ExperimentJUNGGameNodeValue<Long>, Font>() {
    ...
    Transformer<ExperimentJUNGGameNodeValue<Long>, Paint> vertexPaint =
        new Transformer<ExperimentJUNGGameNodeValue<Long>, Paint>() {
          public Paint transform(ExperimentJUNGGameNodeValue<Long> vertex) {
            if (vertex.getIsWinning()) return Color.GREEN;
            else return Color.RED;
          }
        };
    // Set up a new stroke Transformer for the edges
    float nodeDash[] = {7.0f, 2.0f};
    final Stroke normalStroke =
        new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f);
    final Stroke initialStroke =
        new BasicStroke(3.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, nodeDash, 0.0f);
    Transformer<ExperimentJUNGGameNodeValue<Long>, Stroke> vertexStroke =
        new Transformer<ExperimentJUNGGameNodeValue<Long>, Stroke>() {
          public Stroke transform(ExperimentJUNGGameNodeValue<Long> vertex) {
            if (vertex.getIsInitial()) return initialStroke;
            else return normalStroke;
          }
        };
    // Set up a new stroke Transformer for the edges
    float dash[] = {10.0f};
    final Stroke noncontrollableStroke =
        new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, dash, 0.0f);
    final Stroke controllableStroke =
        new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f);
    Transformer<ExperimentJUNGGameEdgeValue<String, Long>, Stroke> edgeStrokeTransformer =
        new Transformer<ExperimentJUNGGameEdgeValue<String, Long>, Stroke>() {
          public Stroke transform(ExperimentJUNGGameEdgeValue<String, Long> edge) {
            if (edge.getIsControllable()) return controllableStroke;
            else return noncontrollableStroke;
          }
        };
    Transformer<ExperimentJUNGGameNodeValue<Long>, Shape> vertexSize =
        new Transformer<ExperimentJUNGGameNodeValue<Long>, Shape>() {
    ...
    Transformer<
            Context<
                Graph<ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>,
                ExperimentJUNGGameEdgeValue<String, Long>>,
            Shape>
        edgeArrowTransformer =
            new DirectionalEdgeArrowTransformer<
                ExperimentJUNGGameNodeValue<Long>, ExperimentJUNGGameEdgeValue<String, Long>>(
                10, 8, 4);
