...
public class ExperimentJUNGGameNodeValue<ID> implements JSONAware {
  ...
  public ExperimentJUNGGameNodeValue(
      ID id,
      List<ExperimentJUNGGameFluent> fluentsValuations,
      boolean isWinning,
      boolean isInitial) {
    this.id = id;
  ...
  public String toString() {
    ...
    for (ExperimentJUNGGameFluent fluent : fluentsValuations) {
      if (fluent.getValue()) {
        if (valuationsString != null) valuationsString += "<br>";
        valuationsString += fluent.toString();
      }
    }
    return "<html>" + id.toString() + "<br>" + valuationsString + "</html>";
  }
  ...
  public String toJSONString() {
    ...
    for (ExperimentJUNGGameFluent fluent : fluentsValuations) {
      ...
      if (valuationsString != null) valuationsString += ",";
      else valuationsString = "[";
