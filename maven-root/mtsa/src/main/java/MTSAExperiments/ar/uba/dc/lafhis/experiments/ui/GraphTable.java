...
public class GraphTable extends JTable {
  ...
  public TableCellRenderer getCellRenderer(int row, int column) {
    ...
    if (dataModel.getValueAt(row, column) instanceof JSONCompatibleObject)
      if (((JSONCompatibleObject) dataModel.getValueAt(row, column)).getValue()
          instanceof DirectedSparseMultigraph) renderer = new JUNGGraphVisualizationRenderer();
  ...
  public TableCellEditor getCellEditor(int row, int column) {
    ...
    if (dataModel.getValueAt(row, column) instanceof JSONCompatibleObject)
      if (((JSONCompatibleObject) dataModel.getValueAt(row, column)).getValue()
          instanceof DirectedSparseMultigraph)
