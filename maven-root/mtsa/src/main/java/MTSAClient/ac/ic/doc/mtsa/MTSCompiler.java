...
/**
 * Wrapper for LTSCompiler that can produce CompositeState or MTS representations of processes
 * defined in FSP
 */
public class MTSCompiler {
  ...
  public CompositeState compileCompositeState(String modelName, File inputFile, LTSOutput output)
      throws IOException {
    LTSInput input = new FileInput(inputFile);
    return compileComposite(modelName, input, output);
  }

  public CompositeState compileCompositeState(String modelName, String inputString)
      throws IOException {
  ...
  public CompositeState compileComposite(String modelName, LTSInput input, LTSOutput output)
      throws IOException {
