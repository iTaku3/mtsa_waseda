...
//#include "LedMatrix8x8/LEDMatrix8x8.h"
...
// Custom init code for the DuinoBot V1.XX
	...
	//Timer 1
	//=====================================================================
	// The timer 1 isn't being used by the core, but it's jumping to the ISR
	// resetting the uC. Thats why I force to disable de Timer1 interrupt here.
	// If tone or servo use this, there will be no problem.
	...
	//Timer 3
	//=====================================================================
	// This timer isn't used by the core

	//=====================================================================
	//Timer 4 Motors PWM (A & B)
	//=====================================================================
