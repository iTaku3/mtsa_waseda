...
public class DistributionFeedbackOnModalityMismatch<S, A> implements DistributionFeedbackItem {
  ...
  public String getMessage() {
    ...
    message
        .append(".\n Trace to state allowing the maybe action: ")
        .append(this.getTraceAsListOfActions(this.traceToStateWithMayTransition));
    message
        .append(".\n Trace to state allowing the required action: ")
        .append(this.getTraceAsListOfActions(this.traceToStateWithReqTransition))
        .append("\n");
