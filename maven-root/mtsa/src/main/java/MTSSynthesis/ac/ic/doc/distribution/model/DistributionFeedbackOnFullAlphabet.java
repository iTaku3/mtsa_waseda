...
public class DistributionFeedbackOnFullAlphabet<A> implements DistributionFeedbackItem {
  ...
  public DistributionFeedbackOnFullAlphabet(
      AlphabetDistribution<A> alphabetDistribution, Set<A> systemModelActions) {
  ...
  public String getMessage() {
    ...
    message
        .append("is not compatible with the system model's alphabet: ")
        .append(this.systemModelActions)
        .append("\n");
