 ...
 * @author gsibay
 */
public class DeterminisationModalityMismatchImpl<S, A>
    implements DeterminisationModalityMismatch<S, A> {

  private S stateWithReqTransition;
  private S stateWithMayTransition;
  private A action;

  public DeterminisationModalityMismatchImpl(
      S stateWithReqTransition, S stateWithPossTransition, A action) {
  ...
  public boolean equals(final Object obj) {
    if (obj instanceof DeterminisationModalityMismatchImpl<?, ?>) {
      ...
      return new EqualsBuilder()
          ...
          .append(
              this.getStateByModality(TransitionType.MAYBE),
              other.getStateByModality(TransitionType.MAYBE))
          .append(
              this.getStateByModality(TransitionType.REQUIRED),
              other.getStateByModality(TransitionType.REQUIRED))
          .isEquals();
    } else {
      return false;
    }
