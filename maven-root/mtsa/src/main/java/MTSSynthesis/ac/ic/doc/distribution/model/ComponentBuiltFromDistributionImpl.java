 ...
 * @param <S>
 */
public class ComponentBuiltFromDistributionImpl<A, S>
    implements ComponentBuiltFromDistribution<S, A> {

  private MTS<Set<S>, A> component;
  private Set<DeterminisationModalityMismatch<S, A>> determinisationModalityMismtches;

  @SuppressWarnings("unchecked")
  public ComponentBuiltFromDistributionImpl(
      MTS<Set<S>, A> component,
      Set<DeterminisationModalityMismatch<S, A>> determinisationModalityMismtches) {
    this.component = component;
    this.determinisationModalityMismtches =
        SetUtils.unmodifiableSet(determinisationModalityMismtches);
  }
