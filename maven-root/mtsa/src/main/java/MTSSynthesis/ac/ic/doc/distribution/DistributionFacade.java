...
public class DistributionFacade<S, A> {
  ...
  private DistributionAlgorithm<S, A> distributionAlgorithm =
      new DistributionAlgorithmDefaultImpl<S, A>();
  ...
  public DistributionResult<S, A> tryDistribute(
    ...
    // Validate.isTrue(this.alphabetDistributionCoversAllActions(monolithicModel.getActions(),
    // alphabetDistribution.getAlphabets()));
    return this.distributionAlgorithm.tryDistribute(
        monolithicModel, alphabetDistribution, tauAction);
  }
