...
public abstract class BinaryFormula implements Formula {
  ...
  public String toString() {
    ...
    result
        .append(this.getLeftFormula().toString())
        .append(" ")
        .append(this.operatorToString())
        .append(" ")
        .append(this.getRightFormula().toString());
    return result.toString();
  }

  /**
   * Returns the string representation of the operator to be used for showing purposes only
   *
   * @return
   */
