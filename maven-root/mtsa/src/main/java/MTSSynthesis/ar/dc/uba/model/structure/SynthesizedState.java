...
public class SynthesizedState {
  ...
  public SynthesizedState(
      Word significativeSuffix, Obligations obligations, ZetaFunction zetaFunction) {
  ...
  public String toString() {
    ...
    buffer
        .append("<")
        .append(this.getSignificativeSuffix())
        .append(";")
        .append(this.getObligations())
        .append(this.zetaFunction)
        .append(">");
  ...
  public boolean equals(Object anObject) {
    ...
    if (anObject instanceof SynthesizedState) {
      ...
      return (new EqualsBuilder())
          .append(this.getSignificativeSuffix(), state.getSignificativeSuffix())
          .append(this.getObligations(), state.getObligations())
          .append(this.getZetaFunction(), state.getZetaFunction())
          .isEquals();
    } else {
      return false;
    }
