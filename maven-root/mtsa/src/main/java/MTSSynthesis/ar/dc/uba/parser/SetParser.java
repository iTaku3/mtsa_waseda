 ...
 *
 * <p>The String representation has the Strings separated by comma and the set is delimited by {}.
 * White spaces are stripped. For example:
 *
 * <p>{lightOff, engineOn,lightOn} or {a,b,c} or {a|b|c, d|c}
 *
 * @author gsibay
 */
