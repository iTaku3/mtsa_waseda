...
/**
 * Parses an Alphabet from a String. The alphabet is a set of string representing Symbols (does not
 * works with conditions). example: {turnOn turnOff goUp goDown} or {a b c f}
 *
 * @author gsibay
 */
