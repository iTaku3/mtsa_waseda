...
public class WordUtils {
  ...
  /**
   * Return the suffixes of a Word. The empty word and the word itself are suffixes.
   *
   * @param word
   * @return
   */
  ...
  /**
   * Return the preffixes of a Word. The empty word and the word itself are preffixes.
   *
   * @param word
   * @return
   */
  ...
  /**
   * Returns the first symbols of the elements of the set of words. The words can not be empties
   *
   * @return
   */
  ...
  /**
   * Returns the set of Word following the start symbol The original set is not modified (neither
   * the set's words)
   *
   * @param words
  ...
  /**
   * When using word algorithms for obtaining prefixes, suffixes, etc, a result may be an invalid
   * canonical word. Usualy this is avoided by selecting the words with odd size.
   *
   * @param input
   * @param output
   */
  public void selectOddSizedWords(Iterable<Word> input, Collection<Word> output) {
    Predicate<Word> oddWordSizePredicate =
        new Predicate<Word>() {
