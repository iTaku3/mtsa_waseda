...
public class CanonicalSymbol implements Symbol {
  ...
  public boolean equals(Object anObject) {
    ...
    if (anObject instanceof CanonicalSymbol) {
      ...
      return new EqualsBuilder()
          .append(this.symbol, canonicalSymbol.getSymbol())
          .append(this.conditionsNames, canonicalSymbol.getConditionsNames())
          .isEquals();
    } else {
      return false;
    }
  ...
  public int hashCode() {
    return new HashCodeBuilder(17, 39)
        ...
        .append(this.getConditionsNames())
        .toHashCode();
  }
}
