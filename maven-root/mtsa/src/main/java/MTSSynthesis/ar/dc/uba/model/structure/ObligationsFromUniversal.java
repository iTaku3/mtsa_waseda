...
public class ObligationsFromUniversal implements Obligations {
  ...
  public String toString() {
    ...
    buff.append("Req Paths = ")
        .append(this.requiredPaths)
        .append("May Paths = ")
        .append(this.maybePaths);
  ...
  public boolean equals(Object anObject) {
    ...
    if (anObject instanceof ObligationsFromUniversal) {
      ...
      return (new EqualsBuilder())
          .append(obl.getRequiredPaths(), this.getRequiredPaths())
          .append(obl.getMaybePaths(), this.getMaybePaths())
          .isEquals();
    } else {
      return false;
    }
  ...
  public int hashCode() {
    return new HashCodeBuilder(17, 39)
        .append(this.getRequiredPaths())
        .append(this.getMaybePaths())
        .toHashCode();
  }
}
