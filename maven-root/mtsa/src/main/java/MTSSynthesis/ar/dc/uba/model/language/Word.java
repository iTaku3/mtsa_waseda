...
public class Word {
  ...
  public static Transformer<Word, List<Symbol>> TO_SYMBOLS_TRANSFORMER =
      new Word.WordToSymbolsTransformer();
  ...
  /**
   * Returns true if the word starts with the symbol. If the word is empty returns false (there is
   * no starting symbol)
   *
   * @param symbol
   * @return
