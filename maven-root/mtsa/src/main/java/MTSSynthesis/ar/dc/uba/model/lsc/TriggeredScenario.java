...
public abstract class TriggeredScenario {
  ...
  public TriggeredScenario(
      Chart prechart, Chart mainchart, Set<Symbol> restricted, Set<Fluent> fluents)
  ...
  private Alphabet calculateAlphabet(
      Chart prechart, Chart mainchart, Set<Symbol> restricted, Set<Fluent> fluents) {
  ...
  public int hashCode() {
    ...
    return new HashCodeBuilder()
        .append(this.getPrechart())
        .append(this.getMainchart())
  ...
  public String toString() {
    ...
    buffer
        .append("Prechart's linearisations: ")
        .append(this.getPrechart().getLinearisations().toString())
        .append("\n");
    buffer.append("Mainchart: ").append(this.getMainchart().toString()).append("\n");
    buffer
        .append("Mainchart's linearisations: ")
        .append(this.getMainchart().getLinearisations().toString())
        .append("\n");
