...
public class ZetaFunction implements Valuation {
  ...
  /** The key is the name of the fluent. The value is the Fluent and the current valuation */
  ...
  public boolean equals(Object anObject) {
    ...
    if (anObject instanceof ZetaFunction) {
      ...
      return new EqualsBuilder()
          .append(this.fluentWithValuations, zetaFunction.fluentWithValuations)
          .isEquals();
    } else {
      return false;
    }
  ...
  private class FluentValuationTuple {
    ...
    public boolean equals(Object anObject) {
      ...
      if (anObject instanceof FluentValuationTuple) {
        ...
        return new EqualsBuilder()
            .append(this.getFluent(), fluentValuation.getFluent())
            .append(this.getCurrentValue(), fluentValuation.getCurrentValue())
            .isEquals();
      } else {
        return false;
      }
