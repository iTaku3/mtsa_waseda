...
public class BGRRank extends GRRank {
  ...
  /**
   * This increases the Buchi part of the rank first, and when it reaches the maximum it increases
   * the GR part and resets the Buchi part.
   */
  @Override
  ...
  /**
   * This increases the GR part of the rank and resets the Buchi part. Since an assumption was found
   * the count of buchi states while not in assumption must be reset, and the number of assumptions
  ...
  public void set(Rank rank) {
    ...
    Validate.isTrue(instance, "Rank of type " + rank.getClass() + " cannot be asigned to BGRRank");
