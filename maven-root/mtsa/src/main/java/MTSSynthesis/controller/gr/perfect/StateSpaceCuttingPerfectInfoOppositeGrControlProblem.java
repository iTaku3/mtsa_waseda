...
public class StateSpaceCuttingPerfectInfoOppositeGrControlProblem
    extends StateSpaceCuttingControlProblem<Long, String> {
  ...
  public StateSpaceCuttingPerfectInfoOppositeGrControlProblem(
      LTS<Long, String> env,
      ControllerGoal<String> grControlGoal,
      Long trapState,
      boolean runNoG,
  ...
  protected Set<Long> solveAssumptions(LTS<Long, String> currentEnvironment) {
    ...
    LabelledGame<Long, String> game =
        new SimpleLabelledGame<Long, String>(this.environment, controllable);
    GRRankSystem<Long> system =
        new GRRankSystem<Long>(
            ...
            grGoal.getFailures());
    PerfectInfoOppositeGRLabelledGameSolver<Long, String> solver =
        new PerfectInfoOppositeGRLabelledGameSolver<Long, String>(game, system);
    solver.solveGame();
  ...
  protected LTS<Long, String> primitiveSolve() {
    ...
    else if (runNoG) losingStates = winningNoG;
  ...
  public LTS<Long, String> buildStrategy() {
    LTS<StrategyState<Long, Integer>, String> result =
        GameStrategyToLTSBuilder.getInstance()
            .buildLTSFrom(environment, gameSolver.buildStrategy());
  ...
  protected LabelledGameSolver<Long, String, Integer> buildGameSolver() {
    ...
    GRLabelledGame<Long, String> game =
        new GRLabelledGame<Long, String>(
            this.environment, controllerGoal.getControllableActions(), grGoal);
    GRRankSystem<Long> system =
        new GRRankSystem<Long>(
            game.getStates(),
            grGoal.getGuarantees(),
