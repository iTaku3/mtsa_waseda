...
public class GRRankFunction<State> extends AbstractRankFunction<State>
    implements RankFunction<State> {
  ...
  private ConcurrentHashMap<State, GRRank>
      function; // This is a ranking function. It maps every state to a Rank
