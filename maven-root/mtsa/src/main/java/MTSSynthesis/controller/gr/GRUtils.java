...
public class GRUtils {
  ...
  // TODO: Strategy State
  public static <State, Memory> Set<State> getStatesFrom(
      Set<StrategyState<State, Memory>> strategyStates) {
  ...
  public static <State, Memory> Set<State> getStates(
      Set<StrategyState<State, Memory>> strategyStates) {
    Set<State> states = new HashSet<State>();
    for (StrategyState<State, Memory> strategyState : strategyStates) {
      states.add(strategyState.getState());
  ...
  public static <State, Memory> Set<StrategyState<State, Memory>> getStrategyStatesFrom(
      Memory guarantee, Set<State> states) {
