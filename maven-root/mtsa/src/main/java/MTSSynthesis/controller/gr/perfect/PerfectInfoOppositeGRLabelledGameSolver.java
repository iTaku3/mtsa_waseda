...
public class PerfectInfoOppositeGRLabelledGameSolver<State, Action>
    extends OppositeGRLabelledGameSolver<State, Action> {

  protected LabelledGame<State, Action> game;

  public PerfectInfoOppositeGRLabelledGameSolver(
      LabelledGame<State, Action> game, GRRankSystem<State> rankSystem) {
    this.setGame(game);
