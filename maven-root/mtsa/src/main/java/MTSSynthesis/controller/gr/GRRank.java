...
public class GRRank implements Rank {
  ...
  public GRRank(GRRankContext context, int value, int assume) {
    this.context = context;
    Validate.isTrue(
        this.context.inRange(value, assume), "Rank value and/or assume are out of range.");
    this.value = value;
    this.assume = assume;
  }
  ...
  public void set(int value, int assumption) {
    Validate.isTrue(
        this.getContext().inRange(value, assumption), "The rank values are out of range.");
    this.value = value;
  ...
  public void set(Rank rank) {
    ...
    Validate.isTrue(
        this.getContext().equals(grRank.getContext()),
        "Rank contexts are incompatible. [" + this + ", " + rank + "]");
    Validate.isTrue(
        this.getContext().inRange(grRank.getValue(), grRank.getAssume()),
  ...
  public int compareTo(Rank other) {
    ...
    Validate.isTrue(
        this.getContext().equals(grOther.getContext()),
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder()
        .append(this.value, grRank.getValue())
        .append(this.assume, grRank.getAssume())
        .isEquals();
  }
