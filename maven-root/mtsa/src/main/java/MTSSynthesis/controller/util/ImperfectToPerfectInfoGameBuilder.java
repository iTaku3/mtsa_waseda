...
public class ImperfectToPerfectInfoGameBuilder<State, Action> {
  ...
  public ImperfectToPerfectInfoGameBuilder(
      MTS<State, Action> nonDet, Set<Action> controllableSet, Action newControllable) {
    this.nonDet = nonDet;
  ...
  public MTS<Pair<Set<State>, Set<Action>>, Action> buildPerfectInfoGame() {
    ...
    MTS<Pair<Set<State>, Set<Action>>, Action> result =
        new MTSImpl<Pair<Set<State>, Set<Action>>, Action>(initial);
    ...
    while (!toVisit.isEmpty()) {
      ...
      Set<Action> intersection =
          Sets.intersection(enabledControllableActions, this.controllableSet);
      ...
      for (Set<Action> controllables : controllablePowerSet) {
        ...
        result.addTransition(
            currentState, this.newControllable, intermediateState, TransitionType.REQUIRED);
  ...
  private Set<Action> enabledControllableActions(Set<State> currentSet) {
    ...
    for (State state : currentSet) {
      BinaryRelation<Action, State> transitions =
          this.nonDet.getTransitions(state, TransitionType.REQUIRED);
  ...
  private Set<State> computeSuccessorsSet(
      Pair<Set<State>, Set<Action>> intermediateState, Action action) {
