...
/**
 * This class converts a generic LTS into a LTS<Long,String>. It was created in order to adapt
 * generic LTS into LTS<Long,String> since some MTSA functions handle only this kind of LTSs. The
 * actions are transformed using the toString() method, and the states are numbered from 0 starting
 * from the initial state.
 *
 * @author mcerrutti
 */
public class GenericLTSStrategyStateToStateConverter<S, A, M>
    implements Transformer<LTS<StrategyState<S, M>, A>, LTS<S, A>> {
