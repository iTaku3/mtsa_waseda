...
public class GameStrategyToLTSBuilder {
  ...
  public static GameStrategyToLTSBuilder getInstance() {
    return instance;
  }
   ...
   */
  public <State, Action> LTS<StrategyState<State, Integer>, Action> buildLTSFrom(
      LTS<State, Action> lts, Strategy<State, Integer> strategy) {
    StrategyState<State, Integer> initialState =
        new StrategyState<State, Integer>(lts.getInitialState(), 1);
    LTS<StrategyState<State, Integer>, Action> result =
        new LTSImpl<StrategyState<State, Integer>, Action>(initialState);
