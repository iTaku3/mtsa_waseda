...
public class GBRank /* implements Rank */ {
  ...
  //	static public void setHeight(int height) { // this function should be available to set the
  // height before
  //		                                             // any rank is available
  //		Rank.height = height;
  //	}
  //
  //	static public void setWidth(int width) { // this function should be available to set the width
  // before
  //		                                              // any rank is available
  //		Rank.width = width;
  //	}
