...
public class RankBasedGameSolverWorker<S, M> implements Runnable {
  ...
  public RankBasedGameSolverWorker(
      Queue<StrategyState<S, M>> q,
      RankBasedGameSolver<S, M> rb,
      AtomicInteger r,
      AtomicBoolean we,
      Phaser af) {
    pendingQueue = q;
  ...
  public RankBasedGameSolverWorker(
      Queue<StrategyState<S, M>> pending, RankBasedGameSolver<S, M> smRankBasedGameSolver) {
