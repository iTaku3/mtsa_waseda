...
public abstract class GRControProblem<S, A, M> implements ControlProblem<S, A> {
  ...
  public GRControProblem(LTS<S, A> environment, ControllerGoal<A> controllerGoal) {
  ...
  protected Set<Set<S>> buildGuarantees() {
    ...
    formulasToGuarantees(
        guarantees, environment.getStates(), controllerGoal.getGuarantees(), valuation);
  ...
  protected Set<S> buildAssumptions() {
    ...
    formulasToAssumptions(
        assumptions, environment.getStates(), controllerGoal.getGuarantees(), valuation);
