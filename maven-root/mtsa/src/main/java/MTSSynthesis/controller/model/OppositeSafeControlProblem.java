...
public class OppositeSafeControlProblem extends StateSpaceCuttingControlProblem<Long, String> {

  protected boolean relaxAllControllables;
  protected boolean relaxOnAssumptions;
  protected boolean relaxSelfLoops;

  public OppositeSafeControlProblem(
      LTS<Long, String> env,
  ...
  protected LabelledGameSolver<Long, String, Integer> buildGameSolver() {
    if (gameSolver == null)
      gameSolver =
          new OppositeSafeGameSolver(
              environment,
              controllerGoal.getControllableActions(),
              buildGuarantees(),
              buildAssumptions(),
