...
/**
 * This Goal represents the goal as defined in the model. It is basically a holder for all
 * assumptions and fluents related to the goal.
 *
 * <p>It does not interpret what type of controller to build.
 *
 * @param <Action>
 */
