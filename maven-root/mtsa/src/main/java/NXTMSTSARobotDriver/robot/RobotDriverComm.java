...
/**
 * Clase encargada de la comunicacion via BlueThooth Traduce los codigos de comando en llamadas a
 * los comandos de robot y devuelve los resultados obtenidos al centro de comando
 *
 * @author Julio
 */
public class RobotDriverComm {
  ...
  private void executeCommand(int cmdId, DataOutputStream dos, DataInputStream dis)
      throws IOException {
