...
public class EV3Robot extends Robot {
  ...
  */
  ...
  private void followPath(boolean reverse) throws RobotLostException {
    ...
    double velMax =
        this.getVelocidadMaxima(); // velocidad (grados por segundo) m�xima de los motores
  ...
  public void setDebugMode(boolean debugMode) {
    ...
    if (debugMode) System.out.println("Debug mode on");
