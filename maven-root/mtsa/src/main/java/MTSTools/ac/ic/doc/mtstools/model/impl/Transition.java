...
/**
 * This class represents a transition as an entity with destination state <code>to</code>, an action
 * <code>action</code> and a type <code>type</code>.
 *
 * @author srdipi TODO el compositionState aca no esta nada bueno y ademas no queda claro para que
 *     esta aqui
 * @param <Action>
 */
public class Transition<Action> {
  ...
  public String toString() {
    return new StringBuffer()
        .append(
            "To: " + this.getTo() + " - Action: " + this.getAction() + " - Type: " + this.getType())
        .toString();
  }
