...
public class LTSSimulationSemantics extends BaseSemanticsByRelation
    implements Refinement, ImplementationNotion {
  ...
  public LTSSimulationSemantics(Set<String> silentActions) {
    super(
        new FixedPointRelationConstructor(new WeakBackwardSimulation<String>(silentActions)),
        silentActions);
  }
}
