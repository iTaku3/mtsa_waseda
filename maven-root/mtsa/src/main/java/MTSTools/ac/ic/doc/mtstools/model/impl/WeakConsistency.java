...
/**
 * This class implements a weak consistency relation, which characterises consistency between models
 * under weak semantics. If the silent actions sets is empty then it characterises strong
 * consistency.
 */
