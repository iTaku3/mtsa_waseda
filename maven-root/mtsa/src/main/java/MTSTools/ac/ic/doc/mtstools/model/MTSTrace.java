...
public interface MTSTrace<A, S> extends Iterable<MTSTransition<A, S>> {
  ...
  /** Clears the trace leaving it without any transitions. Turns the trace into an empty trace. */
  ...
  /**
   * Gets the transition in position i of the trace. Positions are numbered as done in a List.
   *
   * @param i
   * @return
   */
  ...
  /**
   * Removes transition at position i of the trace. Positions are numbered as done in a List.
   *
   * @param i
   */
