...
public class GraphUtils {
  ...
  /**
   * @param sccs the strongly connected components of the mts. See {@link
   *     GraphUtils#getStronglyConnectedComponents}
   * @param mts
   ...
   * @return an MTS built with the states present in states and that maintains the transitions
   *     present in baseMts
   */
