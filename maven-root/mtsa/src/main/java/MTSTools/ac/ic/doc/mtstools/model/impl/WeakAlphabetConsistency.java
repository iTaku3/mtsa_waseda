...
public class WeakAlphabetConsistency extends AbstractConsistencyRelation implements Consistency {
  ...
  protected <S1, S2, A> FixedPointRelationConstructor getRelationContructor(
    ...
    return new FixedPointRelationConstructor(
        new SimulationChain()
            ...
            .add(
                new WeakAlphabetConsistencyBackwardSimulation(
                    mtsA, mtsB, this.getSilentActions())));
  }
}
