...
public class MTSCompositionAdapter<Action> {
   ...
   */
  private Map<Long, Map<Action, List<Pair<Long, TransitionType>>>>
      cacheTransitionsFromStateGroupedByAction;
  ...
  public Map<Action, List<Pair<Long, TransitionType>>> groupByAction(Long state) {
    ...
    return (Map<Action, List<Pair<Long, TransitionType>>>)
        cacheTransitionsFromStateGroupedByAction.get(state);
  }
  ...
  public Collection<Transition<Action>> getTransitions(Long state, TransitionType type) {
    Map<TransitionType, Map<Long, Collection<Transition<Action>>>>
        cacheTransitionsByTypeAndByState =
            new HashMap<TransitionType, Map<Long, Collection<Transition<Action>>>>();
    // Me fijo si ya agregue el type al cache
    if (!cacheTransitionsByTypeAndByState.containsKey(type)) {
      cacheTransitionsByTypeAndByState.put(
          type, new HashMap<Long, Collection<Transition<Action>>>());
    }
    // me fijo si ya agregue las transiciones al map para ese type
    Map<Long, Collection<Transition<Action>>> localCacheTransitionByType =
        cacheTransitionsByTypeAndByState.get(type);
   ...
   * @param to
   * @return
   * @see ac.ic.doc.mtstools.model.MTS#addPossible(java.lang.Object, java.lang.Object,
   *     java.lang.Object)
   */
   ...
   * @param to
   * @return
   * @see ac.ic.doc.mtstools.model.MTS#addRequired(java.lang.Object, java.lang.Object,
   *     java.lang.Object)
   */
   ...
   * @param type
   * @return
   * @see ac.ic.doc.mtstools.model.MTS#addTransition(java.lang.Object, java.lang.Object,
   *     java.lang.Object, ac.ic.doc.mtstools.model.MTS.TransitionType)
   */
