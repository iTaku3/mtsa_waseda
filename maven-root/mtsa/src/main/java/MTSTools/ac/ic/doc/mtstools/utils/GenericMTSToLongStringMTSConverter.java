...
/**
 * This class converts a generic MTS into a MTS<Long,String>. It was created in order to adapt
 * generic MTS into MTS<Long,String> since some MTSA functions handle only this kind of MTSs. The
 * actions are transformed using the toString() method, and the states are numbered from 0 starting
 * from the initial state.
 *
 * @author fdario
 */
public class GenericMTSToLongStringMTSConverter<S, A>
    implements Transformer<MTS<S, A>, MTS<Long, String>> {
