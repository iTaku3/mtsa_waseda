 ...
 * @author gsibay
 */
public class DirectComponentProjectionBuilder implements ComponentProjectionBuilder {
  ...
  public MTS<Long, String> buildComponentProjection(
    ...
    MTS<Long, String> component =
        new MTSImpl<Long, String>(new Long(centralisedMTS.getInitialState().longValue()));

    Map<Long, BinaryRelation<String, Long>> maybeTransitions =
        centralisedMTS.getTransitions(TransitionType.MAYBE);
    ...
    for (Long centralisedState : centralisedMTS.getStates()) {
      ...
      BinaryRelation<String, Long> maybeTransitionsForState =
          maybeTransitions.get(centralisedState);

      for (Pair<String, Long> transition :
          centralisedMTS.getTransitions(centralisedState, TransitionType.POSSIBLE)) {
