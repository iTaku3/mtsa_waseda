...
public class MapSetBinaryRelation<E1, E2> extends AbstractSet<Pair<E1, E2>>
  ...
  public MapSetBinaryRelation() {
    //		this((Class<? extends ConcurrentMap<E1,Set<E2>>>)ConcurrentHashMap.class, (Class<? extends
    // Set<E2>>)HashSet.class);
    //	}

    //	private MapSetBinaryRelation(Class<? extends ConcurrentMap<E1,Set<E2>>> mapClass, Class<?
    // extends Set<E2>> setClass) {
    Object tmp1 = ConcurrentHashMap.class;
    Class<? extends ConcurrentMap<E1, Set<E2>>> mapClass =
        (Class<? extends ConcurrentMap<E1, Set<E2>>>) tmp1;
