 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.RegExpImpl#getVal <em>Val</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.RegExpImpl#getAssrt <em>Assrt</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.RegExpImpl#isEmpty <em>Empty</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.RegExpImpl#getLeft <em>Left</em>}
 * </ul>
 *
 * @generated
 */
public class RegExpImpl extends MinimalEObjectImpl.Container implements RegExp {
  ...
  public void setVal(String newVal) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, SpectraPackage.REG_EXP__VAL, oldVal, val));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.REG_EXP__ASSRT, oldAssrt, newAssrt);
  ...
  public void setAssrt(BooleanTerm newAssrt) {
    if (newAssrt != assrt) {
      ...
      if (assrt != null)
        msgs =
            ((InternalEObject) assrt)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.REG_EXP__ASSRT, null, msgs);
      if (newAssrt != null)
        msgs =
            ((InternalEObject) newAssrt)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.REG_EXP__ASSRT, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.REG_EXP__ASSRT, newAssrt, newAssrt));
  }
  ...
  public void setEmpty(boolean newEmpty) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.REG_EXP__EMPTY, oldEmpty, empty));
  }
  ...
  public NotificationChain basicSetLeft(RegExp newLeft, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.REG_EXP__LEFT, oldLeft, newLeft);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setLeft(RegExp newLeft) {
    if (newLeft != left) {
      ...
      if (left != null)
        msgs =
            ((InternalEObject) left)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.REG_EXP__LEFT, null, msgs);
      if (newLeft != null)
        msgs =
            ((InternalEObject) newLeft)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.REG_EXP__LEFT, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.REG_EXP__LEFT, newLeft, newLeft));
  }
