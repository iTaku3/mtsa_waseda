 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.DefineDeclImpl#getSimpleExpr <em>Simple Expr</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.DefineDeclImpl#getDimensions <em>Dimensions</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.DefineDeclImpl#getInnerArray <em>Inner Array</em>}
 * </ul>
 *
 * @generated
 */
public class DefineDeclImpl extends ReferrableImpl implements DefineDecl {
   ...
   * @generated
   */
  public NotificationChain basicSetSimpleExpr(
      TemporalExpression newSimpleExpr, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.DEFINE_DECL__SIMPLE_EXPR,
              oldSimpleExpr,
              newSimpleExpr);
  ...
  public void setSimpleExpr(TemporalExpression newSimpleExpr) {
    if (newSimpleExpr != simpleExpr) {
      ...
      if (simpleExpr != null)
        msgs =
            ((InternalEObject) simpleExpr)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.DEFINE_DECL__SIMPLE_EXPR,
                    null,
                    msgs);
      if (newSimpleExpr != null)
        msgs =
            ((InternalEObject) newSimpleExpr)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.DEFINE_DECL__SIMPLE_EXPR,
                    null,
    ...
    if (dimensions == null) {
      dimensions =
          new EObjectContainmentEList<SizeDefineDecl>(
              SizeDefineDecl.class, this, SpectraPackage.DEFINE_DECL__DIMENSIONS);
    }
    return dimensions;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.DEFINE_DECL__INNER_ARRAY,
              oldInnerArray,
              newInnerArray);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setInnerArray(DefineArray newInnerArray) {
    if (newInnerArray != innerArray) {
      ...
      if (innerArray != null)
        msgs =
            ((InternalEObject) innerArray)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.DEFINE_DECL__INNER_ARRAY,
                    null,
                    msgs);
      if (newInnerArray != null)
        msgs =
            ((InternalEObject) newInnerArray)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.DEFINE_DECL__INNER_ARRAY,
                    null,
