 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.DefineArrayImpl#getSimpleExprs <em>Simple Exprs</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.DefineArrayImpl#getInnerArrays <em>Inner Arrays</em>}
 * </ul>
 *
 * @generated
 */
public class DefineArrayImpl extends MinimalEObjectImpl.Container implements DefineArray {
  /**
   * The cached value of the '{@link #getSimpleExprs() <em>Simple Exprs</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getInnerArrays() <em>Inner Arrays</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (simpleExprs == null) {
      simpleExprs =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.DEFINE_ARRAY__SIMPLE_EXPRS);
    }
    return simpleExprs;
  }
  ...
  public EList<DefineArray> getInnerArrays() {
    if (innerArrays == null) {
      innerArrays =
          new EObjectContainmentEList<DefineArray>(
              DefineArray.class, this, SpectraPackage.DEFINE_ARRAY__INNER_ARRAYS);
    }
    return innerArrays;
  }
