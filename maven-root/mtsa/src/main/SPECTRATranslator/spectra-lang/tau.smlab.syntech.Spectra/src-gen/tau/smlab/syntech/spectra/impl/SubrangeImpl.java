 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.SubrangeImpl#getFrom <em>From</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.SubrangeImpl#getTo <em>To</em>}
 * </ul>
 *
 * @generated
 */
public class SubrangeImpl extends MinimalEObjectImpl.Container implements Subrange {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.SUBRANGE__FROM, oldFrom, newFrom);
  ...
  public void setFrom(SizeDefineDecl newFrom) {
    if (newFrom != from) {
      ...
      if (from != null)
        msgs =
            ((InternalEObject) from)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.SUBRANGE__FROM, null, msgs);
      if (newFrom != null)
        msgs =
            ((InternalEObject) newFrom)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.SUBRANGE__FROM, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.SUBRANGE__FROM, newFrom, newFrom));
  }
  ...
  public NotificationChain basicSetTo(SizeDefineDecl newTo, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(this, Notification.SET, SpectraPackage.SUBRANGE__TO, oldTo, newTo);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
    ...
    if (newTo != to) {
      ...
      if (to != null)
        msgs =
            ((InternalEObject) to)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.SUBRANGE__TO, null, msgs);
      if (newTo != null)
        msgs =
            ((InternalEObject) newTo)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.SUBRANGE__TO, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, SpectraPackage.SUBRANGE__TO, newTo, newTo));
  }
