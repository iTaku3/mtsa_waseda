 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.DefineRegExpImpl#getDefineRegsList <em>Define Regs
 *       List</em>}
 * </ul>
 *
 * @generated
...
public class DefineRegExpImpl extends DeclImpl implements DefineRegExp {
  /**
   * The cached value of the '{@link #getDefineRegsList() <em>Define Regs List</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public EList<DefineRegExpDecl> getDefineRegsList() {
    if (defineRegsList == null) {
      defineRegsList =
          new EObjectContainmentEList<DefineRegExpDecl>(
              DefineRegExpDecl.class, this, SpectraPackage.DEFINE_REG_EXP__DEFINE_REGS_LIST);
    }
