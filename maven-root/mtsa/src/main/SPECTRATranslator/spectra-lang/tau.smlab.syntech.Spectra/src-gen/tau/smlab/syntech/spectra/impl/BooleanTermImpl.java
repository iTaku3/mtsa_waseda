 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.BooleanTermImpl#getRelExpr <em>Rel Expr</em>}
 * </ul>
 *
 * @generated
 */
public class BooleanTermImpl extends MinimalEObjectImpl.Container implements BooleanTerm {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.BOOLEAN_TERM__REL_EXPR,
              oldRelExpr,
              newRelExpr);
  ...
  public void setRelExpr(TemporalExpression newRelExpr) {
    if (newRelExpr != relExpr) {
      ...
      if (relExpr != null)
        msgs =
            ((InternalEObject) relExpr)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.BOOLEAN_TERM__REL_EXPR,
                    null,
                    msgs);
      if (newRelExpr != null)
        msgs =
            ((InternalEObject) newRelExpr)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.BOOLEAN_TERM__REL_EXPR,
                    null,
