 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.VarImpl#getKind <em>Kind</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.VarImpl#getVar <em>Var</em>}
 * </ul>
 *
 * @generated
 */
public class VarImpl extends DeclImpl implements Var {
  ...
  public void setKind(VarOwner newKind) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, SpectraPackage.VAR__KIND, oldKind, kind));
  }
  ...
  public NotificationChain basicSetVar(VarDecl newVar, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(this, Notification.SET, SpectraPackage.VAR__VAR, oldVar, newVar);
  ...
  public void setVar(VarDecl newVar) {
    if (newVar != var) {
      ...
      if (var != null)
        msgs =
            ((InternalEObject) var)
                .eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SpectraPackage.VAR__VAR, null, msgs);
      if (newVar != null)
        msgs =
            ((InternalEObject) newVar)
                .eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SpectraPackage.VAR__VAR, null, msgs);
      msgs = basicSetVar(newVar, msgs);
      if (msgs != null) msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, SpectraPackage.VAR__VAR, newVar, newVar));
  }
