 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.TypedParamImpl#getType <em>Type</em>}
 * </ul>
 *
 * @generated
 */
public class TypedParamImpl extends ReferrableImpl implements TypedParam {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.TYPED_PARAM__TYPE, oldType, newType);
  ...
  public void setType(VarType newType) {
    if (newType != type) {
      ...
      if (type != null)
        msgs =
            ((InternalEObject) type)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.TYPED_PARAM__TYPE, null, msgs);
      if (newType != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.TYPED_PARAM__TYPE, newType, newType));
  }
