 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalRemainderExprImpl#getLeft <em>Left</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalRemainderExprImpl#getOperator
 *       <em>Operator</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalRemainderExprImpl#getRight <em>Right</em>}
 * </ul>
 *
 * @generated
 */
public class TemporalRemainderExprImpl extends TemporalExpressionImpl
    implements TemporalRemainderExpr {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_REMAINDER_EXPR__LEFT,
              oldLeft,
              newLeft);
      ...
      if (left != null)
        msgs =
            ((InternalEObject) left)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_REMAINDER_EXPR__LEFT,
                    null,
                    msgs);
      if (newLeft != null)
        msgs =
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_REMAINDER_EXPR__OPERATOR,
              oldOperator,
              operator));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_REMAINDER_EXPR__RIGHT,
              oldRight,
              newRight);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (right != null)
        msgs =
            ((InternalEObject) right)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_REMAINDER_EXPR__RIGHT,
                    null,
                    msgs);
      if (newRight != null)
        msgs =
