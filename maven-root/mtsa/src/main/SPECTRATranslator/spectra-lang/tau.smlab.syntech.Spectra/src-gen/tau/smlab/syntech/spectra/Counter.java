 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.Counter#getRange <em>Range</em>}
 *   <li>{@link tau.smlab.syntech.spectra.Counter#getInitial <em>Initial</em>}
 *   <li>{@link tau.smlab.syntech.spectra.Counter#getResetPred <em>Reset Pred</em>}
 *   <li>{@link tau.smlab.syntech.spectra.Counter#getIncPred <em>Inc Pred</em>}
 *   <li>{@link tau.smlab.syntech.spectra.Counter#getDecPred <em>Dec Pred</em>}
 *   <li>{@link tau.smlab.syntech.spectra.Counter#getOverflowMethod <em>Overflow Method</em>}
 *   <li>{@link tau.smlab.syntech.spectra.Counter#getUnderflowMethod <em>Underflow Method</em>}
 * </ul>
 *
...
public interface Counter extends Decl, Referrable {
  ...
  /**
   * Sets the value of the '{@link tau.smlab.syntech.spectra.Counter#getRange <em>Range</em>}'
  ...
  /**
   * Returns the value of the '<em><b>Initial</b></em>' containment reference list. The list
   * contents are of type {@link tau.smlab.syntech.spectra.TemporalExpression}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Reset Pred</b></em>' containment reference list. The list
   * contents are of type {@link tau.smlab.syntech.spectra.TemporalExpression}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Inc Pred</b></em>' containment reference list. The list
   * contents are of type {@link tau.smlab.syntech.spectra.TemporalExpression}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Dec Pred</b></em>' containment reference list. The list
   * contents are of type {@link tau.smlab.syntech.spectra.TemporalExpression}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Overflow Method</b></em>' attribute list. The list contents
   * are of type {@link tau.smlab.syntech.spectra.OverflowMethod}. The literals are from the
   * enumeration {@link tau.smlab.syntech.spectra.OverflowMethod}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Underflow Method</b></em>' attribute list. The list contents
   * are of type {@link tau.smlab.syntech.spectra.OverflowMethod}. The literals are from the
   * enumeration {@link tau.smlab.syntech.spectra.OverflowMethod}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
