 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.VarTypeImpl#getName <em>Name</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.VarTypeImpl#getSubr <em>Subr</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.VarTypeImpl#getConst <em>Const</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.VarTypeImpl#getType <em>Type</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.VarTypeImpl#getDimensions <em>Dimensions</em>}
 * </ul>
 *
 * @generated
 */
public class VarTypeImpl extends MinimalEObjectImpl.Container implements VarType {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.VAR_TYPE__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetSubr(Subrange newSubr, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.VAR_TYPE__SUBR, oldSubr, newSubr);
  ...
  public void setSubr(Subrange newSubr) {
    if (newSubr != subr) {
      ...
      if (subr != null)
        msgs =
            ((InternalEObject) subr)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.VAR_TYPE__SUBR, null, msgs);
      if (newSubr != null)
        msgs =
            ((InternalEObject) newSubr)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.VAR_TYPE__SUBR, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.VAR_TYPE__SUBR, newSubr, newSubr));
  }
  ...
  public EList<TypeConstant> getConst() {
    if (const_ == null) {
      const_ =
          new EObjectContainmentEList<TypeConstant>(
              TypeConstant.class, this, SpectraPackage.VAR_TYPE__CONST);
    }
    return const_;
  }
    ...
    if (type != null && type.eIsProxy()) {
      ...
      if (type != oldType) {
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this, Notification.RESOLVE, SpectraPackage.VAR_TYPE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(TypeDef newType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.VAR_TYPE__TYPE, oldType, type));
  }
  ...
  public EList<SizeDefineDecl> getDimensions() {
    if (dimensions == null) {
      dimensions =
          new EObjectContainmentEList<SizeDefineDecl>(
              SizeDefineDecl.class, this, SpectraPackage.VAR_TYPE__DIMENSIONS);
    }
    return dimensions;
  }
