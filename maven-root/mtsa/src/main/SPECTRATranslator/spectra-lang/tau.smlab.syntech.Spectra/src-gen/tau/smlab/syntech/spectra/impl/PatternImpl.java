 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.PatternImpl#getName <em>Name</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.PatternImpl#getParams <em>Params</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.PatternImpl#getVarDeclList <em>Var Decl List</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.PatternImpl#getInitial <em>Initial</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.PatternImpl#getSafety <em>Safety</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.PatternImpl#getStateInv <em>State Inv</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.PatternImpl#getJustice <em>Justice</em>}
 * </ul>
 *
 * @generated
 */
public class PatternImpl extends DeclImpl implements Pattern {
  ...
  /**
   * The cached value of the '{@link #getVarDeclList() <em>Var Decl List</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.PATTERN__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetParams(PatternParamList newParams, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.PATTERN__PARAMS, oldParams, newParams);
  ...
  public void setParams(PatternParamList newParams) {
    if (newParams != params) {
      ...
      if (params != null)
        msgs =
            ((InternalEObject) params)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.PATTERN__PARAMS, null, msgs);
      if (newParams != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.PATTERN__PARAMS, newParams, newParams));
  }
  ...
  public EList<VarDecl> getVarDeclList() {
    if (varDeclList == null) {
      varDeclList =
          new EObjectContainmentEList<VarDecl>(
              VarDecl.class, this, SpectraPackage.PATTERN__VAR_DECL_LIST);
    }
    return varDeclList;
  }
    ...
    if (initial == null) {
      initial =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.PATTERN__INITIAL);
    }
    return initial;
  }
  ...
  public EList<TemporalExpression> getSafety() {
    if (safety == null) {
      safety =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.PATTERN__SAFETY);
    }
    return safety;
  }
  ...
  public EList<TemporalExpression> getStateInv() {
    if (stateInv == null) {
      stateInv =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.PATTERN__STATE_INV);
    }
    return stateInv;
  }
  ...
  public EList<TemporalExpression> getJustice() {
    if (justice == null) {
      justice =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.PATTERN__JUSTICE);
    }
    return justice;
  }
