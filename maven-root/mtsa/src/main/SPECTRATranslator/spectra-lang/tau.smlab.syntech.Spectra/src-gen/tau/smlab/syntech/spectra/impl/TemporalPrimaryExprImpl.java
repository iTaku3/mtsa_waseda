 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalPrimaryExprImpl#getPredPatt <em>Pred
 *       Patt</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalPrimaryExprImpl#getPredPattParams <em>Pred
 *       Patt Params</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalPrimaryExprImpl#getOperator
 *       <em>Operator</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalPrimaryExprImpl#getTpe <em>Tpe</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalPrimaryExprImpl#getPointer <em>Pointer</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalPrimaryExprImpl#getIndex <em>Index</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalPrimaryExprImpl#getTemporalExpression
 *       <em>Temporal Expression</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalPrimaryExprImpl#getRegexp <em>Regexp</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalPrimaryExprImpl#getRegexpPointer <em>Regexp
 *       Pointer</em>}
 * </ul>
 *
 * @generated
...
public class TemporalPrimaryExprImpl extends TemporalExpressionImpl implements TemporalPrimaryExpr {
  ...
  /**
   * The cached value of the '{@link #getPredPattParams() <em>Pred Patt Params</em>}' containment
   * reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getTemporalExpression() <em>Temporal Expression</em>}'
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  SpectraPackage.TEMPORAL_PRIMARY_EXPR__PRED_PATT,
                  oldPredPatt,
                  predPatt));
      }
    }
  ...
  public EList<TemporalExpression> getPredPattParams() {
    if (predPattParams == null) {
      predPattParams =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class,
              this,
              SpectraPackage.TEMPORAL_PRIMARY_EXPR__PRED_PATT_PARAMS);
    }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_PRIMARY_EXPR__OPERATOR,
              oldOperator,
              operator));
  }
  ...
  public NotificationChain basicSetTpe(TemporalExpression newTpe, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.TEMPORAL_PRIMARY_EXPR__TPE, oldTpe, newTpe);
  ...
  public void setTpe(TemporalExpression newTpe) {
    if (newTpe != tpe) {
      ...
      if (tpe != null)
        msgs =
            ((InternalEObject) tpe)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_PRIMARY_EXPR__TPE,
                    null,
                    msgs);
      if (newTpe != null)
        msgs =
            ((InternalEObject) newTpe)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_PRIMARY_EXPR__TPE,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.TEMPORAL_PRIMARY_EXPR__TPE, newTpe, newTpe));
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this,
                  Notification.RESOLVE,
                  SpectraPackage.TEMPORAL_PRIMARY_EXPR__POINTER,
                  oldPointer,
                  pointer));
      }
    }
  ...
  public EList<TemporalExpression> getIndex() {
    if (index == null) {
      index =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.TEMPORAL_PRIMARY_EXPR__INDEX);
    }
    return index;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetTemporalExpression(
      TemporalExpression newTemporalExpression, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_PRIMARY_EXPR__TEMPORAL_EXPRESSION,
              oldTemporalExpression,
              newTemporalExpression);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setTemporalExpression(TemporalExpression newTemporalExpression) {
    if (newTemporalExpression != temporalExpression) {
      ...
      if (temporalExpression != null)
        msgs =
            ((InternalEObject) temporalExpression)
                .eInverseRemove(
                    this,
      ...
      if (newTemporalExpression != null)
        msgs =
            ((InternalEObject) newTemporalExpression)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE
                        - SpectraPackage.TEMPORAL_PRIMARY_EXPR__TEMPORAL_EXPRESSION,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_PRIMARY_EXPR__REGEXP,
              oldRegexp,
              newRegexp);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setRegexp(RegExp newRegexp) {
    if (newRegexp != regexp) {
      ...
      if (regexp != null)
        msgs =
            ((InternalEObject) regexp)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_PRIMARY_EXPR__REGEXP,
                    null,
                    msgs);
      if (newRegexp != null)
        msgs =
            ((InternalEObject) newRegexp)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_PRIMARY_EXPR__REGEXP,
                    null,
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this,
                  Notification.RESOLVE,
                  SpectraPackage.TEMPORAL_PRIMARY_EXPR__REGEXP_POINTER,
                  oldRegexpPointer,
                  regexpPointer));
      }
    }
