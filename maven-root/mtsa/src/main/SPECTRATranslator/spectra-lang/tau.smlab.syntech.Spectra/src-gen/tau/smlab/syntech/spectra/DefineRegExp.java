 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.DefineRegExp#getDefineRegsList <em>Define Regs List</em>}
 * </ul>
 *
...
public interface DefineRegExp extends Decl {
  /**
   * Returns the value of the '<em><b>Define Regs List</b></em>' containment reference list. The
   * list contents are of type {@link tau.smlab.syntech.spectra.DefineRegExpDecl}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
