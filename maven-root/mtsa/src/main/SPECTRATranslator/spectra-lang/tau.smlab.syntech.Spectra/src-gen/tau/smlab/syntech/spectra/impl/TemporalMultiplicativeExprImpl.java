 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalMultiplicativeExprImpl#getElements
 *       <em>Elements</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalMultiplicativeExprImpl#getOperator
 *       <em>Operator</em>}
 * </ul>
 *
 * @generated
 */
public class TemporalMultiplicativeExprImpl extends TemporalExpressionImpl
    implements TemporalMultiplicativeExpr {
  /**
    ...
    if (elements == null) {
      elements =
          new EObjectContainmentEList<TemporalExpression>(
              ...
              this,
              SpectraPackage.TEMPORAL_MULTIPLICATIVE_EXPR__ELEMENTS);
    }
    return elements;
  }
    ...
    if (operator == null) {
      operator =
          new EDataTypeEList<String>(
              String.class, this, SpectraPackage.TEMPORAL_MULTIPLICATIVE_EXPR__OPERATOR);
    }
    return operator;
  }
