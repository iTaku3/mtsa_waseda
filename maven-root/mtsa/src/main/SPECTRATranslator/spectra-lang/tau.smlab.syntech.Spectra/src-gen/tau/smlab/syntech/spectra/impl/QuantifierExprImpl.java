 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.QuantifierExprImpl#getOperator <em>Operator</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.QuantifierExprImpl#getDomainVar <em>Domain Var</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.QuantifierExprImpl#getTemporalExpr <em>Temporal
 *       Expr</em>}
 * </ul>
 *
 * @generated
...
public class QuantifierExprImpl extends TemporalExpressionImpl implements QuantifierExpr {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.QUANTIFIER_EXPR__OPERATOR,
              oldOperator,
              operator));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.QUANTIFIER_EXPR__DOMAIN_VAR,
              oldDomainVar,
              newDomainVar);
  ...
  public void setDomainVar(DomainVarDecl newDomainVar) {
    if (newDomainVar != domainVar) {
      ...
      if (domainVar != null)
        msgs =
            ((InternalEObject) domainVar)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.QUANTIFIER_EXPR__DOMAIN_VAR,
                    null,
                    msgs);
      if (newDomainVar != null)
        msgs =
            ((InternalEObject) newDomainVar)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.QUANTIFIER_EXPR__DOMAIN_VAR,
                    null,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.QUANTIFIER_EXPR__TEMPORAL_EXPR,
              oldTemporalExpr,
              newTemporalExpr);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (temporalExpr != null)
        msgs =
            ((InternalEObject) temporalExpr)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.QUANTIFIER_EXPR__TEMPORAL_EXPR,
                    null,
                    msgs);
