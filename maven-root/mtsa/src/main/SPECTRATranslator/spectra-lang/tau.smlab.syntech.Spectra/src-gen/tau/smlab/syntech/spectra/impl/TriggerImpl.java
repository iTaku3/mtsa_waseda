 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.TriggerImpl#getInitPointer <em>Init Pointer</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TriggerImpl#getInitRegExp <em>Init Reg Exp</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TriggerImpl#getEffectPointer <em>Effect Pointer</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TriggerImpl#getEffectRegExp <em>Effect Reg Exp</em>}
 * </ul>
 *
 * @generated
 */
public class TriggerImpl extends MinimalEObjectImpl.Container implements Trigger {
  ...
  /**
   * The cached value of the '{@link #getEffectRegExp() <em>Effect Reg Exp</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  SpectraPackage.TRIGGER__INIT_POINTER,
                  oldInitPointer,
                  initPointer));
      }
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TRIGGER__INIT_REG_EXP,
              oldInitRegExp,
              newInitRegExp);
  ...
  public void setInitRegExp(RegExp newInitRegExp) {
    if (newInitRegExp != initRegExp) {
      ...
      if (initRegExp != null)
        msgs =
            ((InternalEObject) initRegExp)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TRIGGER__INIT_REG_EXP,
                    null,
                    msgs);
      if (newInitRegExp != null)
        msgs =
            ((InternalEObject) newInitRegExp)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TRIGGER__INIT_REG_EXP,
                    null,
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this,
                  Notification.RESOLVE,
                  SpectraPackage.TRIGGER__EFFECT_POINTER,
                  oldEffectPointer,
                  effectPointer));
      }
    }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TRIGGER__EFFECT_REG_EXP,
              oldEffectRegExp,
              newEffectRegExp);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setEffectRegExp(RegExp newEffectRegExp) {
    if (newEffectRegExp != effectRegExp) {
      ...
      if (effectRegExp != null)
        msgs =
            ((InternalEObject) effectRegExp)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TRIGGER__EFFECT_REG_EXP,
                    null,
                    msgs);
      if (newEffectRegExp != null)
        msgs =
            ((InternalEObject) newEffectRegExp)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TRIGGER__EFFECT_REG_EXP,
                    null,
