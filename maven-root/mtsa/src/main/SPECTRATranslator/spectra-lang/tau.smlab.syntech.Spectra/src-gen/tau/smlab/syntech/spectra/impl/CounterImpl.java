 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.CounterImpl#getName <em>Name</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.CounterImpl#getRange <em>Range</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.CounterImpl#getInitial <em>Initial</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.CounterImpl#getResetPred <em>Reset Pred</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.CounterImpl#getIncPred <em>Inc Pred</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.CounterImpl#getDecPred <em>Dec Pred</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.CounterImpl#getOverflowMethod <em>Overflow
 *       Method</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.CounterImpl#getUnderflowMethod <em>Underflow
 *       Method</em>}
 * </ul>
 *
 * @generated
...
public class CounterImpl extends DeclImpl implements Counter {
  ...
  /**
   * The cached value of the '{@link #getResetPred() <em>Reset Pred</em>}' containment reference
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #getUnderflowMethod() <em>Underflow Method</em>}' attribute
   * list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.COUNTER__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetRange(Subrange newRange, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.COUNTER__RANGE, oldRange, newRange);
  ...
  public void setRange(Subrange newRange) {
    if (newRange != range) {
      ...
      if (range != null)
        msgs =
            ((InternalEObject) range)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.COUNTER__RANGE, null, msgs);
      if (newRange != null)
        msgs =
            ((InternalEObject) newRange)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.COUNTER__RANGE, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.COUNTER__RANGE, newRange, newRange));
  }
    ...
    if (initial == null) {
      initial =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.COUNTER__INITIAL);
    }
    return initial;
  }
  ...
  public EList<TemporalExpression> getResetPred() {
    if (resetPred == null) {
      resetPred =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.COUNTER__RESET_PRED);
    }
    return resetPred;
  }
  ...
  public EList<TemporalExpression> getIncPred() {
    if (incPred == null) {
      incPred =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.COUNTER__INC_PRED);
    }
    return incPred;
  }
  ...
  public EList<TemporalExpression> getDecPred() {
    if (decPred == null) {
      decPred =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.COUNTER__DEC_PRED);
    }
    return decPred;
  }
  ...
  public EList<OverflowMethod> getOverflowMethod() {
    if (overflowMethod == null) {
      overflowMethod =
          new EDataTypeEList<OverflowMethod>(
              OverflowMethod.class, this, SpectraPackage.COUNTER__OVERFLOW_METHOD);
    }
  ...
  public EList<OverflowMethod> getUnderflowMethod() {
    if (underflowMethod == null) {
      underflowMethod =
          new EDataTypeEList<OverflowMethod>(
              OverflowMethod.class, this, SpectraPackage.COUNTER__UNDERFLOW_METHOD);
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
    if (baseClass == Referrable.class) {
      switch (derivedFeatureID) {
        case SpectraPackage.COUNTER__NAME:
          return SpectraPackage.REFERRABLE__NAME;
        default:
          return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
    if (baseClass == Referrable.class) {
      switch (baseFeatureID) {
        case SpectraPackage.REFERRABLE__NAME:
          return SpectraPackage.COUNTER__NAME;
        default:
          return -1;
      }
    }
