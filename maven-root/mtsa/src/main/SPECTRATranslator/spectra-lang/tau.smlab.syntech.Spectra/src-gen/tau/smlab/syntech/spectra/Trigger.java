 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.Trigger#getInitPointer <em>Init Pointer</em>}
 *   <li>{@link tau.smlab.syntech.spectra.Trigger#getInitRegExp <em>Init Reg Exp</em>}
 *   <li>{@link tau.smlab.syntech.spectra.Trigger#getEffectPointer <em>Effect Pointer</em>}
 *   <li>{@link tau.smlab.syntech.spectra.Trigger#getEffectRegExp <em>Effect Reg Exp</em>}
 * </ul>
 *
...
public interface Trigger extends EObject {
  ...
  /**
   * Sets the value of the '{@link tau.smlab.syntech.spectra.Trigger#getInitPointer <em>Init
   * Pointer</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link tau.smlab.syntech.spectra.Trigger#getInitRegExp <em>Init Reg
   * Exp</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link tau.smlab.syntech.spectra.Trigger#getEffectPointer <em>Effect
   * Pointer</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link tau.smlab.syntech.spectra.Trigger#getEffectRegExp <em>Effect Reg
   * Exp</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
