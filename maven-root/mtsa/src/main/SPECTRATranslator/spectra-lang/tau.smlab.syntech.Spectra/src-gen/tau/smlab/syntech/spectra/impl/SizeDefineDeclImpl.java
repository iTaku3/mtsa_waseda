 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.SizeDefineDeclImpl#getValue <em>Value</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.SizeDefineDeclImpl#getName <em>Name</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.SizeDefineDeclImpl#getArithExp <em>Arith Exp</em>}
 * </ul>
 *
 * @generated
 */
public class SizeDefineDeclImpl extends MinimalEObjectImpl.Container implements SizeDefineDecl {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.SIZE_DEFINE_DECL__VALUE, oldValue, value));
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  SpectraPackage.SIZE_DEFINE_DECL__NAME,
                  oldName,
                  name));
      }
    }
  ...
  public void setName(DefineDecl newName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.SIZE_DEFINE_DECL__NAME, oldName, name));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetArithExp(
      TemporalExpression newArithExp, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.SIZE_DEFINE_DECL__ARITH_EXP,
              oldArithExp,
              newArithExp);
  ...
  public void setArithExp(TemporalExpression newArithExp) {
    if (newArithExp != arithExp) {
      ...
      if (arithExp != null)
        msgs =
            ((InternalEObject) arithExp)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.SIZE_DEFINE_DECL__ARITH_EXP,
                    null,
                    msgs);
      if (newArithExp != null)
        msgs =
            ((InternalEObject) newArithExp)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.SIZE_DEFINE_DECL__ARITH_EXP,
                    null,
