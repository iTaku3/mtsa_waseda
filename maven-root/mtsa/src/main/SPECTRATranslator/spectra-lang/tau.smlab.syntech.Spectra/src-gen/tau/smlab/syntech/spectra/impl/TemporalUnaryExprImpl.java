 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalUnaryExprImpl#getKinds <em>Kinds</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalUnaryExprImpl#getTue <em>Tue</em>}
 * </ul>
 *
 * @generated
 */
public class TemporalUnaryExprImpl extends TemporalExpressionImpl implements TemporalUnaryExpr {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.TEMPORAL_UNARY_EXPR__KINDS, oldKinds, kinds));
  }
  ...
  public NotificationChain basicSetTue(TemporalExpression newTue, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.TEMPORAL_UNARY_EXPR__TUE, oldTue, newTue);
  ...
  public void setTue(TemporalExpression newTue) {
    if (newTue != tue) {
      ...
      if (tue != null)
        msgs =
            ((InternalEObject) tue)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_UNARY_EXPR__TUE,
                    null,
                    msgs);
      if (newTue != null)
        msgs =
            ((InternalEObject) newTue)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_UNARY_EXPR__TUE,
                    null,
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.TEMPORAL_UNARY_EXPR__TUE, newTue, newTue));
  }
