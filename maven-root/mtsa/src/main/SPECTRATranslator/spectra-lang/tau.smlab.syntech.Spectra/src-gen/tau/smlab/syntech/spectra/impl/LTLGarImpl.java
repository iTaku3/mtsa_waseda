 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLGarImpl#getName <em>Name</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLGarImpl#getParams <em>Params</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLGarImpl#getSafety <em>Safety</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLGarImpl#getStateInv <em>State Inv</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLGarImpl#getJustice <em>Justice</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLGarImpl#getTemporalExpr <em>Temporal Expr</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLGarImpl#getTrig <em>Trig</em>}
 * </ul>
 *
 * @generated
 */
public class LTLGarImpl extends DeclImpl implements LTLGar {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_GAR__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetParams(TypedParamList newParams, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_GAR__PARAMS, oldParams, newParams);
  ...
  public void setParams(TypedParamList newParams) {
    if (newParams != params) {
      ...
      if (params != null)
        msgs =
            ((InternalEObject) params)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_GAR__PARAMS, null, msgs);
      if (newParams != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_GAR__PARAMS, newParams, newParams));
  }
  ...
  public void setSafety(String newSafety) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_GAR__SAFETY, oldSafety, safety));
  }
  ...
  public void setStateInv(String newStateInv) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_GAR__STATE_INV, oldStateInv, stateInv));
  }
  ...
  public void setJustice(String newJustice) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_GAR__JUSTICE, oldJustice, justice));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.LTL_GAR__TEMPORAL_EXPR,
              oldTemporalExpr,
              newTemporalExpr);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
      ...
      if (temporalExpr != null)
        msgs =
            ((InternalEObject) temporalExpr)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_GAR__TEMPORAL_EXPR,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetTrig(Trigger newTrig, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_GAR__TRIG, oldTrig, newTrig);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setTrig(Trigger newTrig) {
    if (newTrig != trig) {
      ...
      if (trig != null)
        msgs =
            ((InternalEObject) trig)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_GAR__TRIG, null, msgs);
      if (newTrig != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_GAR__TRIG, newTrig, newTrig));
  }
