 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.EXGarImpl#getName <em>Name</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.EXGarImpl#getElements <em>Elements</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.EXGarImpl#getRegExpPointer <em>Reg Exp Pointer</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.EXGarImpl#getRegExp <em>Reg Exp</em>}
 * </ul>
 *
 * @generated
 */
public class EXGarImpl extends DeclImpl implements EXGar {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.EX_GAR__NAME, oldName, name));
  }
    ...
    if (elements == null) {
      elements =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.EX_GAR__ELEMENTS);
    }
    return elements;
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  SpectraPackage.EX_GAR__REG_EXP_POINTER,
                  oldRegExpPointer,
                  regExpPointer));
      }
    }
  ...
  public NotificationChain basicSetRegExp(RegExp newRegExp, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.EX_GAR__REG_EXP, oldRegExp, newRegExp);
  ...
  public void setRegExp(RegExp newRegExp) {
    if (newRegExp != regExp) {
      ...
      if (regExp != null)
        msgs =
            ((InternalEObject) regExp)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.EX_GAR__REG_EXP, null, msgs);
      if (newRegExp != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.EX_GAR__REG_EXP, newRegExp, newRegExp));
  }
