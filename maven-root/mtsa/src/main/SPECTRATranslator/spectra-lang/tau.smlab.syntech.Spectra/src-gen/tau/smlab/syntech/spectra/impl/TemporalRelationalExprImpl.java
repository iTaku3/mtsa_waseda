 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalRelationalExprImpl#getLeft <em>Left</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalRelationalExprImpl#getOperator
 *       <em>Operator</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalRelationalExprImpl#getRight <em>Right</em>}
 * </ul>
 *
 * @generated
 */
public class TemporalRelationalExprImpl extends TemporalExpressionImpl
    implements TemporalRelationalExpr {
  /**
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_RELATIONAL_EXPR__LEFT,
              oldLeft,
              newLeft);
      ...
      if (left != null)
        msgs =
            ((InternalEObject) left)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_RELATIONAL_EXPR__LEFT,
                    null,
                    msgs);
      if (newLeft != null)
        msgs =
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_RELATIONAL_EXPR__OPERATOR,
              oldOperator,
              operator));
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_RELATIONAL_EXPR__RIGHT,
              oldRight,
              newRight);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setRight(TemporalExpression newRight) {
    if (newRight != right) {
      ...
      if (right != null)
        msgs =
            ((InternalEObject) right)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_RELATIONAL_EXPR__RIGHT,
                    null,
                    msgs);
      if (newRight != null)
        msgs =
            ((InternalEObject) newRight)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_RELATIONAL_EXPR__RIGHT,
                    null,
