 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalImpExprImpl#getLeft <em>Left</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalImpExprImpl#getOperator <em>Operator</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.TemporalImpExprImpl#getImplication
 *       <em>Implication</em>}
 * </ul>
 *
 * @generated
...
public class TemporalImpExprImpl extends TemporalExpressionImpl implements TemporalImpExpr {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.TEMPORAL_IMP_EXPR__LEFT, oldLeft, newLeft);
  ...
  public void setLeft(TemporalExpression newLeft) {
    if (newLeft != left) {
      ...
      if (left != null)
        msgs =
            ((InternalEObject) left)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_IMP_EXPR__LEFT,
                    null,
                    msgs);
      if (newLeft != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.TEMPORAL_IMP_EXPR__LEFT, newLeft, newLeft));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_IMP_EXPR__OPERATOR,
              oldOperator,
              operator));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetImplication(
      TemporalExpression newImplication, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.TEMPORAL_IMP_EXPR__IMPLICATION,
              oldImplication,
              newImplication);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setImplication(TemporalExpression newImplication) {
    if (newImplication != implication) {
      ...
      if (implication != null)
        msgs =
            ((InternalEObject) implication)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_IMP_EXPR__IMPLICATION,
                    null,
                    msgs);
      if (newImplication != null)
        msgs =
            ((InternalEObject) newImplication)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.TEMPORAL_IMP_EXPR__IMPLICATION,
                    null,
