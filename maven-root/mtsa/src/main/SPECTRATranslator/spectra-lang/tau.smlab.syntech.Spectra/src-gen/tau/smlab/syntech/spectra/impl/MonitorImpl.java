 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.MonitorImpl#getName <em>Name</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.MonitorImpl#getType <em>Type</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.MonitorImpl#getInitial <em>Initial</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.MonitorImpl#getSafety <em>Safety</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.MonitorImpl#getStateInv <em>State Inv</em>}
 * </ul>
 *
 * @generated
 */
public class MonitorImpl extends DeclImpl implements Monitor {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.MONITOR__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetType(VarType newType, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.MONITOR__TYPE, oldType, newType);
  ...
  public void setType(VarType newType) {
    if (newType != type) {
      ...
      if (type != null)
        msgs =
            ((InternalEObject) type)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.MONITOR__TYPE, null, msgs);
      if (newType != null)
        msgs =
            ((InternalEObject) newType)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.MONITOR__TYPE, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.MONITOR__TYPE, newType, newType));
  }
    ...
    if (initial == null) {
      initial =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.MONITOR__INITIAL);
    }
    return initial;
  }
  ...
  public EList<TemporalExpression> getSafety() {
    if (safety == null) {
      safety =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.MONITOR__SAFETY);
    }
    return safety;
  }
  ...
  public EList<TemporalExpression> getStateInv() {
    if (stateInv == null) {
      stateInv =
          new EObjectContainmentEList<TemporalExpression>(
              TemporalExpression.class, this, SpectraPackage.MONITOR__STATE_INV);
    }
    return stateInv;
  }
    ...
    if (baseClass == Referrable.class) {
      switch (baseFeatureID) {
        case SpectraPackage.REFERRABLE__NAME:
          return SpectraPackage.MONITOR__NAME;
        default:
          return -1;
      }
    }
