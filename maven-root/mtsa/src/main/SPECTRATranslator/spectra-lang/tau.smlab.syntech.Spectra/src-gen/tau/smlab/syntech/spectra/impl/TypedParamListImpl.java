 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.TypedParamListImpl#getParams <em>Params</em>}
 * </ul>
 *
 * @generated
 */
public class TypedParamListImpl extends MinimalEObjectImpl.Container implements TypedParamList {
  ...
  public EList<TypedParam> getParams() {
    if (params == null) {
      params =
          new EObjectContainmentEList<TypedParam>(
              TypedParam.class, this, SpectraPackage.TYPED_PARAM_LIST__PARAMS);
    }
    return params;
  }
