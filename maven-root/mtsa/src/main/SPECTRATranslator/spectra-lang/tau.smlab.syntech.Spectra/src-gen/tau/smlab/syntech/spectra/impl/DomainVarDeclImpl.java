 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.DomainVarDeclImpl#getDomainType <em>Domain Type</em>}
 * </ul>
 *
 * @generated
 */
public class DomainVarDeclImpl extends ReferrableImpl implements DomainVarDecl {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.DOMAIN_VAR_DECL__DOMAIN_TYPE,
              oldDomainType,
              newDomainType);
  ...
  public void setDomainType(VarType newDomainType) {
    if (newDomainType != domainType) {
      ...
      if (domainType != null)
        msgs =
            ((InternalEObject) domainType)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.DOMAIN_VAR_DECL__DOMAIN_TYPE,
                    null,
                    msgs);
      if (newDomainType != null)
        msgs =
            ((InternalEObject) newDomainType)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.DOMAIN_VAR_DECL__DOMAIN_TYPE,
                    null,
