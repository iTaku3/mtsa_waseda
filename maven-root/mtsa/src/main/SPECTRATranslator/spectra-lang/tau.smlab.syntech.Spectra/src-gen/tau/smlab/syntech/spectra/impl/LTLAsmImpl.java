 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getName <em>Name</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getParams <em>Params</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getSafety <em>Safety</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getStateInv <em>State Inv</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getJustice <em>Justice</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getTemporalExpr <em>Temporal Expr</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getTrig <em>Trig</em>}
 * </ul>
 *
 * @generated
 */
public class LTLAsmImpl extends DeclImpl implements LTLAsm {
  ...
  /**
   * The cached value of the '{@link #getTemporalExpr() <em>Temporal Expr</em>}' containment
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_ASM__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetParams(TypedParamList newParams, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_ASM__PARAMS, oldParams, newParams);
  ...
  public void setParams(TypedParamList newParams) {
    if (newParams != params) {
      ...
      if (params != null)
        msgs =
            ((InternalEObject) params)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__PARAMS, null, msgs);
      if (newParams != null)
        msgs =
            ((InternalEObject) newParams)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__PARAMS, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_ASM__PARAMS, newParams, newParams));
  }
  ...
  public void setSafety(String newSafety) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_ASM__SAFETY, oldSafety, safety));
  }
  ...
  public void setStateInv(String newStateInv) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_ASM__STATE_INV, oldStateInv, stateInv));
  }
  ...
  public void setJustice(String newJustice) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_ASM__JUSTICE, oldJustice, justice));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetTemporalExpr(
      TemporalExpression newTemporalExpr, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.LTL_ASM__TEMPORAL_EXPR,
              oldTemporalExpr,
              newTemporalExpr);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
  ...
  public void setTemporalExpr(TemporalExpression newTemporalExpr) {
    if (newTemporalExpr != temporalExpr) {
      ...
      if (temporalExpr != null)
        msgs =
            ((InternalEObject) temporalExpr)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__TEMPORAL_EXPR,
                    null,
                    msgs);
      if (newTemporalExpr != null)
        msgs =
            ((InternalEObject) newTemporalExpr)
                .eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__TEMPORAL_EXPR,
                    null,
  ...
  public NotificationChain basicSetTrig(Trigger newTrig, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_ASM__TRIG, oldTrig, newTrig);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
    }
    return msgs;
  ...
  public void setTrig(Trigger newTrig) {
    if (newTrig != trig) {
      ...
      if (trig != null)
        msgs =
            ((InternalEObject) trig)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__TRIG, null, msgs);
      if (newTrig != null)
        msgs =
            ((InternalEObject) newTrig)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__TRIG, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.LTL_ASM__TRIG, newTrig, newTrig));
  }
