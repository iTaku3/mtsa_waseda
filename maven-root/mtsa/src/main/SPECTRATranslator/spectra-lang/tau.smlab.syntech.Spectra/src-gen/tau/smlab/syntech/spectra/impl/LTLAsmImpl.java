...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>LTL Asm</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getName <em>Name</em>}</li>
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getParams <em>Params</em>}</li>
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getSafety <em>Safety</em>}</li>
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getStateInv <em>State Inv</em>}</li>
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getJustice <em>Justice</em>}</li>
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getTemporalExpr <em>Temporal Expr</em>}</li>
 *   <li>{@link tau.smlab.syntech.spectra.impl.LTLAsmImpl#getTrig <em>Trig</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LTLAsmImpl extends DeclImpl implements LTLAsm
{
  /**
  ...
  {
    return SpectraPackage.Literals.LTL_ASM;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetParams(TypedParamList newParams, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__PARAMS, oldParams, newParams);
  ...
  public void setParams(TypedParamList newParams)
  {
    if (newParams != params)
    {
      ...
      if (params != null)
        msgs = ((InternalEObject)params).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__PARAMS, null, msgs);
      if (newParams != null)
        msgs = ((InternalEObject)newParams).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__PARAMS, null, msgs);
      msgs = basicSetParams(newParams, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__PARAMS, newParams, newParams));
  }
  ...
  public void setSafety(String newSafety)
  {
    ...
    safety = newSafety;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__SAFETY, oldSafety, safety));
  }
  ...
  public void setStateInv(String newStateInv)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__STATE_INV, oldStateInv, stateInv));
  }
  ...
  public void setJustice(String newJustice)
  {
    ...
    justice = newJustice;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__JUSTICE, oldJustice, justice));
  }
  ...
  public NotificationChain basicSetTemporalExpr(TemporalExpression newTemporalExpr, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__TEMPORAL_EXPR, oldTemporalExpr, newTemporalExpr);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setTemporalExpr(TemporalExpression newTemporalExpr)
  {
    if (newTemporalExpr != temporalExpr)
    {
      ...
      if (temporalExpr != null)
        msgs = ((InternalEObject)temporalExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__TEMPORAL_EXPR, null, msgs);
      if (newTemporalExpr != null)
        msgs = ((InternalEObject)newTemporalExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__TEMPORAL_EXPR, null, msgs);
      msgs = basicSetTemporalExpr(newTemporalExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__TEMPORAL_EXPR, newTemporalExpr, newTemporalExpr));
  }
  ...
  public NotificationChain basicSetTrig(Trigger newTrig, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__TRIG, oldTrig, newTrig);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setTrig(Trigger newTrig)
  {
    if (newTrig != trig)
    {
      NotificationChain msgs = null;
      if (trig != null)
        msgs = ((InternalEObject)trig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__TRIG, null, msgs);
      if (newTrig != null)
        msgs = ((InternalEObject)newTrig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SpectraPackage.LTL_ASM__TRIG, null, msgs);
      msgs = basicSetTrig(newTrig, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpectraPackage.LTL_ASM__TRIG, newTrig, newTrig));
  }
