 ...
 *
 * <ul>
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#isKleened <em>Kleened</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#isQuestionMark <em>Question
 *       Mark</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#isPlus <em>Plus</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#isHaveExactRepetition <em>Have Exact
 *       Repetition</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#getExactRepetition <em>Exact
 *       Repetition</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#isHaveAtLeast <em>Have At Least</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#getAtLeast <em>At Least</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#isHaveRange <em>Have Range</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#getFrom <em>From</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#getFromDefine <em>From Define</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#getTo <em>To</em>}
 *   <li>{@link tau.smlab.syntech.spectra.impl.UnaryRegExpImpl#getToDefine <em>To Define</em>}
 * </ul>
 *
 * @generated
 */
public class UnaryRegExpImpl extends RegExpImpl implements UnaryRegExp {
  ...
  /**
   * The default value of the '{@link #isHaveExactRepetition() <em>Have Exact Repetition</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #isHaveExactRepetition() <em>Have Exact Repetition</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.UNARY_REG_EXP__KLEENED, oldKleened, kleened));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.UNARY_REG_EXP__QUESTION_MARK,
              oldQuestionMark,
              questionMark));
  }
  ...
  public void setPlus(boolean newPlus) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.UNARY_REG_EXP__PLUS, oldPlus, plus));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.UNARY_REG_EXP__HAVE_EXACT_REPETITION,
              oldHaveExactRepetition,
              haveExactRepetition));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.UNARY_REG_EXP__EXACT_REPETITION,
              oldExactRepetition,
              exactRepetition));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.UNARY_REG_EXP__HAVE_AT_LEAST,
              oldHaveAtLeast,
              haveAtLeast));
  }
  ...
  public void setAtLeast(int newAtLeast) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.UNARY_REG_EXP__AT_LEAST, oldAtLeast, atLeast));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SpectraPackage.UNARY_REG_EXP__HAVE_RANGE,
              oldHaveRange,
              haveRange));
  }
  ...
  public void setFrom(int newFrom) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.UNARY_REG_EXP__FROM, oldFrom, from));
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  SpectraPackage.UNARY_REG_EXP__FROM_DEFINE,
                  oldFromDefine,
                  fromDefine));
      }
    }
  ...
  public void setTo(int newTo) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SpectraPackage.UNARY_REG_EXP__TO, oldTo, to));
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this,
                  Notification.RESOLVE,
                  SpectraPackage.UNARY_REG_EXP__TO_DEFINE,
                  oldToDefine,
                  toDefine));
      }
    }
