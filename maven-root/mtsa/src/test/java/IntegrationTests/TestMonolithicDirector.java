...
public class TestMonolithicDirector {
  ...
  private static final String[] RESOURCE_FOLDERS = {
    "MonolithicDirector/Controllable",
    "MonolithicDirector/ControllableFSPs",
    "MonolithicDirector/NoControllable",
    "MonolithicDirector/NoControllableFSPs"
  };
  private File file;
  ...
  */
  ...
  public void testControllability() throws Exception {
    ...
    if (parent.equals("Controllable") || parent.equals("NoControllable")) {
      ...
      LTS<Long, String> director =
          dcs.synthesize(Probl.plant, Probl.controllable, Probl.disturbances);
