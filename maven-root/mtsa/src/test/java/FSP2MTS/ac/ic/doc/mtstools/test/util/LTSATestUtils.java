...
public class LTSATestUtils {
  ...
  public static CompositeState buildAutomataFromSource(String stringSource, String modelName)
      throws Exception {
  ...
  public static CompositeState buildCompositeState(String sourceString, LTSOutput ltsOutput)
      throws Exception {
