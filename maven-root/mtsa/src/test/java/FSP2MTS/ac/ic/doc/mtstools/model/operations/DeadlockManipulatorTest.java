...
public class DeadlockManipulatorTest extends MTSTestBase {
  ...
  public void testDeadlockMaybeMTS() throws Exception {
    ...
    MTS<Long, String> mts =
        AutomataToMTSConverter.getInstance().convert((CompactState) compositeB.getComposition());
  ...
  public void testDeadlockEmptyMTS() throws Exception {
    ...
    assertEquals(expectedTrace, trace);
    System.out.println(
        "A = (a->b->A). B = (b->a->B). ||C = (A||B). :: Trace to deadlock: " + trace);
  }
  ...
  public void testSimpleDeadlock() throws Exception {
    ...
    MTS<Long, String> mts =
        AutomataToMTSConverter.getInstance().convert((CompactState) composite.getComposition());
    MTSTrace<String, Long> trace = new LinkedListMTSTrace<String, Long>();
  ...
  public void testRemoveTransitionsToDeadlock() throws Exception {
    ...
    CompactState compactState =
        TransitionSystemDispatcher.getPessimistModel(composite.getComposition());
    MTS<Long, String> mts =
