...
public class MergeBuilderTest extends MTSTestBase {
  ...
  public void testMerge0() throws Exception {
    String fsmA =
        "A_0 = ( x -> A_0_1 | x -> A_0_2), A_0_1 = ( a? -> A_0_1 | b? -> A_0_1), A_0_2 = ( c? ->"
            + " A_0_2 | d? -> A_0_2).\r\n";
    String fsmB =
        "B_0 = ( x -> B_0_1 | x -> B_0_2), B_0_1 = ( a? -> B_0_1 | d? -> B_0_1), B_0_2 = ( c? ->"
            + " B_0_2 | b? -> B_0_2).\r\n";
  ...
  public void testMergeC2() throws Exception {
    String fsmA =
        "CA_2 = ( x? -> A_2_1 | x -> A_2_2),A_2_1 = ( a? -> A_2_1),A_2_2 = ( b? -> A_2_2 | c? ->"
            + " A_2_2).\r\n";
    String fsmB =
        "CB_2 = ( x? -> B_2_1 | x -> B_2_2),B_2_1 = ( b? -> B_2_1 ),B_2_2 = ( a? -> B_2_2 | b? ->"
            + " B_2_2 | c? -> B_2_2).\r\n";
    String fsmLCR =
        "CLCR_2 = ( x? -> STOP | x? -> LCR_2_1_2 | x? -> LCR_2_2_1 | x -> LCR_2_2_2 ),"
  ...
  public void testMergeC4() throws Exception {
    String fsmA =
        "CA_4 = ( x? -> A_1 | x -> A_2),A_1 = (a? -> A_1 | b? -> A_1 | c? -> A_1),A_2 = (a? -> A_2"
            + " | b? -> A_2).\r\n";
    String fsmB =
        "CB_4 = ( x? -> B_1 | x -> B_2),B_1 = (a? -> B_1 | b? -> B_1 | c? -> B_1),B_2 = (b? -> B_2"
            + " | c? -> B_2).	\r\n";
    String fsmLCR =
        "CLCR_4 = ( x? -> LCR_2_1_1 | x? -> LCR_2_1_2 | x? -> LCR_2_2_1 | x -> LCR_2_2_2 ),"
  ...
  public void testMergeC5() throws Exception {
    String fsmA =
        "CA_5 = ( x? -> A_1 | x -> A_2),A_1 = (a? -> A_1 | b -> A_1 | c? -> A_1),A_2 = (a? -> A_2 |"
            + " b? -> A_2).\r\n";
    String fsmB =
        "CB_5 = ( x? -> B_1 | x -> B_2),B_1 = (a? -> B_1 | b? -> B_1 | c? -> B_1),B_2 = (b? -> B_2"
            + " | c? -> B_2).\r\n";
  ...
  public void testMerge8() throws Exception {
    String fsmA =
        "A_8 = ( x? -> ( y? -> A_8_2 | y -> A_8_3)),A_8_2 = ( a? -> STOP | b? -> STOP),A_8_3 = ( c?"
            + " -> STOP | d? -> STOP).\r\n";
    String fsmB =
        "B_8 = ( x? -> ( y? -> B_8_2 | y -> B_8_3)),B_8_2 = ( a? -> STOP | d? -> STOP),B_8_3 = ( b?"
            + " -> STOP | c? -> STOP).\r\n";
    String fsmLCR =
        "LCR_8 = ( x? -> ( y? -> LCR_8_2_2 | y -> LCR_8_2_3 | y -> LCR_8_3_2 | y? -> LCR_8_3_3 ) "
