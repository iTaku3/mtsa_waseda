...
public class ZetaFunctionTest {
  ...
  private Fluent createFluent(
      String initiating, String terminating, String name, boolean initialValue) {
    return new FluentImpl(
        name,
        this.toSymbolSet(initiating.split(",")),
        this.toSymbolSet(terminating.split(",")),
        initialValue);
  }
