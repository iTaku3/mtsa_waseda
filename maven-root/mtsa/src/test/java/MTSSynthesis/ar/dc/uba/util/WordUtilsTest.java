...
public class WordUtilsTest {
  ...
  public void testSuffixes() {
    ...
    Collections.addAll(
        ...
        this.parseWord(""),
        this.parseWord("c"),
        this.parseWord("turnOff|c"),
        this.parseWord("turnOn|turnOff|c"));
  ...
  public void testPreffixes() {
    ...
    Collections.addAll(
        ...
        this.parseWord(""),
        this.parseWord("goUp"),
        this.parseWord("goUp|move"),
        this.parseWord("goUp|move|gogo"),
        this.parseWord("goUp|move|gogo|rico"));
  ...
  public void testFirsts() {
    ...
    Collections.addAll(
        originalWords,
        this.parseWord("goUp|goDown"),
        this.parseWord("c|a|b"),
        this.parseWord("turnOff"),
    ...
    Collections.addAll(
        desiredResult,
        new SingleSymbol("c"),
        new SingleSymbol("goUp"),
        new SingleSymbol("turnOff"));
  ...
  public void testFollows() {
    ...
    Set<Word> desiredResult = new HashSet<Word>();
    Collections.addAll(
        desiredResult, this.parseWord("goDown"), this.parseWord("k|li"), this.parseWord(""));

    assertEquals(
        this.getWordUtils().follows(originalWords, new SingleSymbol("goUp")), desiredResult);
