...
public class ChartTest {
  ...
  public void testQtyInteractions() {
    ...
    assertEquals(
        5, this.createOneLinearisationChartWithInteractionAndConditions().getQtyInteractions());

    assertEquals(
        6,
        this.createSeveralLinearisationsChartWithInteractionAndConditions().getQtyInteractions());

    assertEquals(
        6,
        this.createSeveralLinearisationsChartWithInteractionAndConditionsA().getQtyInteractions());

    assertEquals(
        6,
        this.createSeveralLinearisationsChartWithInteractionAndConditionsB().getQtyInteractions());

    assertEquals(
        4, this.createSeveralConditionsBeginingChartWithInteractionsA().getQtyInteractions());

    assertEquals(
        4, this.createSeveralConditionsBeginingChartWithInteractionsB().getQtyInteractions());
  }
  ...
  public void testQtyLinearisations() {
    ...
    assertEquals(
        2, this.createSeveralInteractionChartSeveralLinearisations().getLinearisations().size());
    ...
    assertEquals(
        1,
        this.createOneLinearisationChartWithInteractionAndConditions().getLinearisations().size());

    assertEquals(
        2,
        this.createSeveralLinearisationsChartWithInteractionAndConditions()
            .getLinearisations()
            .size());

    assertEquals(
        2,
        this.createSeveralLinearisationsChartWithInteractionAndConditionsA()
            .getLinearisations()
            .size());

    assertEquals(
        2,
        this.createSeveralLinearisationsChartWithInteractionAndConditionsB()
            .getLinearisations()
            .size());

    assertEquals(
        12,
        this.createSeveralConditionsBeginingChartWithInteractionsA().getLinearisations().size());

    assertEquals(
        4, this.createSeveralConditionsBeginingChartWithInteractionsB().getLinearisations().size());
  }
  ...
  public void testLinearisationsOnlyInteractions() {
    ...
    assertEquals(
        linearisations,
        this.createSeveralInteractionChartSeveralLinearisations().getLinearisations());
  }
  ...
  public void testLinearisationsWithInteractionsAndConditions() {
    ...
    assertEquals(
        linearisations,
        this.createOneLinearisationChartWithInteractionAndConditions().getLinearisations());
  }
  ...
  public void testTwoLinearisationsWithInteractionsAndConditions() {
    ...
    assertEquals(
        linearisations,
        this.createSeveralLinearisationsChartWithInteractionAndConditions().getLinearisations());
  }
  ...
  public void testTwoLinearisationsWithInteractionsAndConditionsA() {
    ...
    assertEquals(
        linearisations,
        this.createSeveralLinearisationsChartWithInteractionAndConditionsA().getLinearisations());
  }
  ...
  public void testTwoLinearisationsWithInteractionsAndConditionsB() {
    ...
    assertSame(
        linearisations,
        this.createSeveralLinearisationsChartWithInteractionAndConditionsB().getLinearisations());
  }
  ...
  public void testTwoLinearisationsSeveralConditionsBeginingChartWithInteractionsB() {
    ...
    System.out.println(
        this.createSeveralConditionsBeginingChartWithInteractionsB().getLinearisations());
  ...
  public void testTwoLinearisationsSeveralConditionsBeginingChartWithInteractionsA() {
    ...
    System.out.println(linearisations);
    System.out.println(
        this.createSeveralConditionsBeginingChartWithInteractionsA().getLinearisations());
