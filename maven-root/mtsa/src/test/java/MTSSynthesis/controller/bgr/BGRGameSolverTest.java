...
public class BGRGameSolverTest extends GRGameSolverBaseTestCase {
  ...
  public void bgrEmptyBuchiExample() throws Exception {
    ...
    guarantee.addState(state1);
    guarantee.addState(state2);
    guarantee.addState(state3);
    guarantee.addState(state4);
    guarantee.addState(state5);
    ...
    BGRRankSystem<Long> rankSystem =
        new BGRRankSystem<Long>(states, guarantees, assumptions, faults, buchi);
