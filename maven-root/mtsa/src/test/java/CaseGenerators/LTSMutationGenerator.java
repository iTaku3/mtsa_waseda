...
public class LTSMutationGenerator {
  ...
  private String generate(
      ArrayList<Symbol> stackAll,
      HashMap<Integer, ArrayList<Symbol>> values,
  ...
  private void parseSymbolForAction(
      Symbol sym, HashMap<Integer, ArrayList<Symbol>> values, ArrayList<Symbol> stackAll) {
  ...
  private void parseSymbolForState(
      Symbol sym, HashMap<Integer, ArrayList<Symbol>> values, ArrayList<Symbol> stackAll) {
