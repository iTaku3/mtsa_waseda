...
public class TestHierarchicalMap extends TestCase {
  ...
  public void testEntrySetWithDuplicates() {
    ...
    // el entryset luego de la eliminacion de todos los elementos locales es igual al entryset del
    // parent
    expectedMap.clear();
  ...
  public void testValueAccessOnKeyOverride() {
    ...
    // si existe en el localmap tiene que encontrarlo siempre independientemente de si hay o no key
    // override
    hm.put("1", "AAAA");
    assertTrue(hm.containsValue("AAAA"));
    hm.put("2", "AAAA");
