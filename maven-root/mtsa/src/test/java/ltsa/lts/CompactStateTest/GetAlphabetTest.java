...
public class GetAlphabetTest {
  ...
  private void assertFileWithAlphabetSolution(String fileInput, String[] solution)
      throws IOException {
    ...
    CompositeState compositeState =
        compiled.continueCompilation("C"); // if no C exists then "Default" will be use
    ...
    Assert.assertTrue(
        "Solution is wrong: " + printAllAlphabet(alphabet), Arrays.equals(alphabet, solution));
  }
