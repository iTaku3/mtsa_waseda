...
public class OppositeSafeGameSolverTests {
  ...
  private void OppositeSafeGameTest(
      String testName,
      String filename,
      String mutName,
      String expName,
  ...
  protected LTS<Long, String> getMut(
    ...
    try {
      ...
      ControllerGoal<String> controllerGoal =
          LTSTestHelper.getInstance().getGRControllerGoalFromFile(filename, controllerName);
      ...
      ReportingPerfectInfoStateSpaceCuttingGRControlProblem grControlProblem =
          new ReportingPerfectInfoStateSpaceCuttingGRControlProblem(
              testName,
              env,
              envForController,
              controllerGoal,
