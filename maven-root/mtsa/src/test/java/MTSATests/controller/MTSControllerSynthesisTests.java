...
public class MTSControllerSynthesisTests {
  ...
  public void testAll() throws Exception {
    ...
    CompositeState model =
        getInstance()
            .compileCompositeState(
                "C_All", TestConstants.fileFrom("mts-control.lts"), testLTSOuput);
    ...
    assertTrue(
        ...
        testLTSOuput.toString().contains("All implementations of C_All can be controlled"));
  }
  ...
  public void testSome() throws Exception {
    ...
    CompositeState model =
        getInstance()
            .compileCompositeState(
                "C_Some", TestConstants.fileFrom("mts-control.lts"), testLTSOuput);
    String name = model.getComposition().name;
    assertTrue("There is no controller for C", !name.contains(ControlConstants.NO_CONTROLLER));
    assertTrue(
        "The answer is not Some",
        testLTSOuput
            .toString()
            .contains("Some implementations of C_Some can be controlled and some cannot."));
  }
  ...
  public void testNone() throws Exception {
    ...
    CompositeState model =
        getInstance()
            .compileCompositeState(
                "C_None", TestConstants.fileFrom("mts-control.lts"), testLTSOuput);
  }
}
