...
public class ComplexTomAndJerry extends BasicTomAndJerryTest {
  ...
  protected void setAssumeAndGuarantee(ControllerGoal<String> goal) {
    ...
    Fluent fluentCatIn4 =
        new FluentImpl(
            "CatIn.4",
            ControllerTestsUtils.buildSymbolSetFrom(new String[] {"cat_in.4"}),
            ControllerTestsUtils.buildSymbolSetFrom(
                new String[] {"cat_in.3", "cat_in.2", "cat_in.0", "cat_in.1"}),
            false);
    Fluent fluentCatIn2 =
        new FluentImpl(
            "CatIn.2",
            ControllerTestsUtils.buildSymbolSetFrom(new String[] {"cat_in.2"}),
            ControllerTestsUtils.buildSymbolSetFrom(
                new String[] {"cat_in.3", "cat_in.4", "cat_in.0", "cat_in.1"}),
            false);
