...
public class BasicTomAndJerryTest extends MTSParsedTestsBase {
  ...
  protected void setAssumeAndGuarantee(ControllerGoal<String> goal) {
    Fluent fluentMouseIn4 =
        new FluentImpl(
            "MouseIn.4",
            ControllerTestsUtils.buildSymbolSetFrom(new String[] {"mouse_in.4"}),
            ControllerTestsUtils.buildSymbolSetFrom(
                new String[] {"mouse_in.3", "mouse_in.2", "mouse_in.0", "mouse_in.1"}),
            false);
    Fluent fluentMouseIn2 =
        new FluentImpl(
            "MouseIn.2",
            ControllerTestsUtils.buildSymbolSetFrom(new String[] {"mouse_in.2"}),
            ControllerTestsUtils.buildSymbolSetFrom(
                new String[] {"mouse_in.3", "mouse_in.4", "mouse_in.0", "mouse_in.1"}),
            false);
  ...
  protected void setControllableActions(ControllerGoal<String> goal) {
    Set<String> controllable =
        ControllerTestsUtils.buildStringsSetFrom(
            new String[] {
              "c1", "c2", "c3", "c4", "c5", "c6", "c7a", "c7b", "m1", "m2", "m3", "m4", "m5", "m6"
            });
