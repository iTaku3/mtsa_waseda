...
public class ProgressLTLPropertyCheck extends LTSLTLPropertyTest {
  ...
  public Object[][] safeGameParameters() {
    return new Object[][] {
      {
        "../ltsa/dist/examples/LTLProperties/Tests/biscotti-idealised.lts",
        new String[] {"SuccessfullyCookedTwice"}
      }
    };
  }

  @Test(dataProvider = "progressLTLPropertyTest")
  private void ProgressLTLPropertyTest(String filename, String[] properties)
