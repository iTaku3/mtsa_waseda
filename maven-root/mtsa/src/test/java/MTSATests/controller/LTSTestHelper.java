...
public class LTSTestHelper {
  ...
  public static LTSTestHelper getInstance() {
    if (instance == null) instance = new LTSTestHelper();
    return instance;
  }

  protected CompositeState getCompositeFromFile(String ltsFilename, String controllerName) {
  ...
  protected LTS<Long, String> getLTSFromFile(String ltsFilename, String modelName) {
    // parse input file
    try {
  ...
  protected Set<String> getControllableActionsFromFile(String ltsFilename, String controllerName) {
    // parse input file
    try {
      LTSInput input = getLtsInput(ltsFilename);
      StandardOutput output = new StandardOutput();
  ...
  protected GRGoal<Long> getGRGoalFromFile(String ltsFilename, String controllerName) {
    // parse input file
    try {
      LTSInput input = getLtsInput(ltsFilename);
      StandardOutput output = new StandardOutput();
