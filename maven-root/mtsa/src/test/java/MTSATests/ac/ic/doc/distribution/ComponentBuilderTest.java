...
public class ComponentBuilderTest {
  ...
  public void testSimpleModelFullProjection() throws Exception {
    ...
    ComponentBuiltFromDistribution<Long, String> result =
        componentBuilder.buildComponent(m, alpha1, alpha1);
    MTS<Set<Long>, String> component = result.getComponent();

    // To make the alphabets equal TAU has to be added (this is so because The MTS compiler adds tau
    // to mStr).
  ...
  public void testNonFullProjection() throws Exception {
    ...
    ComponentBuilder<Long, String> componentBuilder = new ComponentBuilder<Long, String>();
    ComponentBuiltFromDistribution<Long, String> result =
        componentBuilder.buildComponent(i, alpha1, fullAlphabet);
  ...
  public void testSimpleModelNonDetNonFullProjection() throws Exception {
    ...
    String i2Str =
        "I2 = (a? -> Q1 | c? -> Q2), Q1 = ( c? -> Q4), Q2 = (a? -> Q5), Q4 = (b -> STOP), Q5 = (b"
            + " -> STOP).";
  ...
  public void testSimpleModelNonDetDifferentModalities() throws Exception {
    ...
    String i2Str =
        "I2 = (a? -> Q1 | c? -> Q2), Q1 = ( c? -> Q3), Q2 = (a -> Q3), Q3 = (b -> STOP).";

    String i3Str =
        "I3 = (a -> Q1 | c? -> Q2), Q1 = ( c? -> Q3), Q2 = (a? -> Q3), Q3 = (b -> STOP).";
  ...
  public void testTwoMistmatches() throws Exception {
    String iStr =
        "I = Q1, Q1 = (c? -> Q3 | a? -> Q2), Q2 = (c? -> Q4), Q3 = ( a -> Q4), Q4 = (b -> Q5), Q5 ="
            + " (d -> Q6 | a? -> Q8 | c? -> Q7), Q6 = (a? -> Q9), Q7 = (a? -> Q10), Q8 = (d -> Q9 |"
            + " c? -> Q10), Q9 = (b -> Q1), Q10 = (b? -> Q1).";

    String expectedOnAlpha1Str = "IEA = Q1, Q1 = (a -> b -> a? -> b -> Q1)."; // TODO

    String expectedOnAlpha2Str =
        "IEB = Q1, Q1 = (c? -> b -> Q2), Q2 = (c? -> b? -> Q1 | d -> b -> Q1)."; // TODO
  ...
  private void checkMissmatches(
      ...
      MTS<Long, String> monolithicModel) {
    ...
    Set<DeterminisationModalityMismatch<Long, String>> actualMismatches =
        result.getDeterminisationModalityMismatches();
    for (DeterminisationModalityMismatch<Long, String> determinisationModalityMismatch :
        actualMismatches) {
