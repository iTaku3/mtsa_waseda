...
public class HasNonDeterministicTransitionsPredicateTest {
  ...
  public void testHasNonDetTransitionsFromState() throws Exception {
    ...
    predicate =
        new HasNonDeterministicTransitionsStatePredicate<Long, String>(I0, TransitionType.REQUIRED);
    assertTrue(!predicate.evaluate(I0.getInitialState()));

    predicate =
        new HasNonDeterministicTransitionsStatePredicate<Long, String>(I0, TransitionType.MAYBE);
    assertTrue(!predicate.evaluate(I0.getInitialState()));

    MTS<Long, String> I5 = testModels.getMTS(5);

    predicate =
        new HasNonDeterministicTransitionsStatePredicate<Long, String>(I5, TransitionType.POSSIBLE);
    assertTrue(predicate.evaluate(I5.getInitialState()));

    predicate =
        new HasNonDeterministicTransitionsStatePredicate<Long, String>(I5, TransitionType.REQUIRED);
    assertTrue(!predicate.evaluate(I5.getInitialState()));

    predicate =
        new HasNonDeterministicTransitionsStatePredicate<Long, String>(I5, TransitionType.MAYBE);
    assertTrue(!predicate.evaluate(I5.getInitialState()));
  }
