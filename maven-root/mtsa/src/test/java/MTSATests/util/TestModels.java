...
public class TestModels {
  ...
  private final String[] modelsToParse = {
    ...
    "I10 = (c -> Q1 | c? -> Q2 | c -> Q3), Q1 = (b? -> Q2 | b? -> Q3), Q2 = (c-> I10), Q3 = (b ->"
        + " I10 | b? -> Q2).",
    "I11 = Q1, Q1 = (c? -> Q3 | a? -> Q2), Q2 = (c? -> Q4), Q3 = ( a -> Q4), Q4 = (b -> Q5), Q5 ="
        + " (d -> Q6 | a? -> Q8 | c? -> Q7), Q6 = (a? -> Q9), Q7 = (a? -> Q10), Q8 = (d -> Q9 | c?"
        + " -> Q10), Q9 = (b -> Q1), Q10 = (b? -> Q1).",
  ...
  public MTS<Long, String>[] getAllModels() throws Exception {
    for (int i = 0; i < this.getSize(); i++) {
      if (this.parsedModels[i] == null) {
        MTSCompiler compiler = MTSCompiler.getInstance();
        this.parsedModels[i] =
            new UnmodifiableMTS<Long, String>(
                compiler.compileMTS("I" + (i + 1), this.modelsToParse[i]));
      }
    }
