...
public class RandomSchedulerTest {
  ...
  // String definition = "FOLLOW = (follow -> (success -> TURN | lost -> LOST)), TURN = (turnLeft ->
  // (success -> FOLLOW | lost -> LOST)).";
  String definition =
      "FOLLOW = (follow -> (success -> TURN | lost -> LOST)), TURN = (turnLeft -> success -> FOLLOW"
          + " | turnRight -> success -> FOLLOW | turnAround -> success -> FOLLOW | follow ->"
          + " success -> FOLLOW).";
  // String definition = "FOLLOW = (follow -> (success -> TURN | lost -> LOST)), TURN = (turnAround
  // -> success -> FOLLOW ).";
  ...
  public void setUp() throws Exception {
    ...
    // enactor = new UIRobot<Long, String>("ui robot", "follow", "turnLeft", "turnRight",
    // "turnAround", "success", "failure", "lost");
    enactor =
   ...
   * MTSAEnactment.ar.uba.dc.lafhis.enactment.RandomController#takeNextAction()}.
   */
  // @Test
